...
\definecolor{notestgray}{RGB}{200,200,200}
\begin{tikzpicture}[font=\small, node distance=8mm]
% Axes labels
\node[anchor=east, font=\bfseries] at (0,3) {Linguistic Capability};
\node[anchor=north, rotate=90, font=\bfseries] at (-0.5,0) {Test Type};

% Grid cells
\foreach \x in {0,1,2} {
  \foreach \y in {0,1,2} {
    \draw[fill=notestgray!30, draw=black!30, line width=0.5pt, rounded corners=3pt] (\x*2.5,\y*1.5) rectangle (\x*2.5+2.2,\y*1.5+1.2);
  }
}

% Capability labels
\node[anchor=center, font=\small\bfseries] at (1.1,3.3) {Vocabulary};
\node[anchor=center, font=\small\bfseries] at (3.6,3.3) {Negation};
\node[anchor=center, font=\small\bfseries] at (6.1,3.3) {Coreference};

% Test type labels
\node[anchor=east, font=\small\bfseries] at (-0.2,2.1) {Invariance};
\node[anchor=east, font=\small\bfseries] at (-0.2,0.6) {Directional};
\node[anchor=east, font=\small\bfseries] at (-0.2,-0.9) {Minimum};

% Coverage markers (example coverage pattern)
\filldraw[fill=coverageblue!60, draw=coverageblue!80!black, line width=1pt, rounded corners=3pt] (0.3,1.8) rectangle (1.9,2.7);
\filldraw[fill=coverageblue!60, draw=coverageblue!80!black, line width=1pt, rounded corners=3pt] (2.8,1.8) rectangle (4.4,2.7);
\filldraw[fill=coverageblue!60, draw=coverageblue!80!black, line width=1pt, rounded corners=3pt] (5.3,0.3) rectangle (6.9,1.2);
\filldraw[fill=coverageblue!60, draw=coverageblue!80!black, line width=1pt, rounded corners=3pt] (0.3,-0.6) rectangle (1.9,0.3);

% Legend
\node[anchor=west, font=\small\bfseries] at (7.5,2.5) {Coverage:};
\draw[fill=coverageblue!60, draw=coverageblue!80!black, line width=1pt, rounded corners=2pt] (7.5,1.8) rectangle (7.9,2.2);
\node[anchor=west, font=\small] at (8.1,2.0) {Tested};
\draw[fill=notestgray!30, draw=black!30, line width=0.5pt, rounded corners=2pt] (7.5,1.2) rectangle (7.9,1.6);
\node[anchor=west, font=\small] at (8.1,1.4) {Not tested};
\end{tikzpicture}
\end{llmfigbox}
...
\begin{tikzpicture}[font=\small]
% Dashboard layout
\draw[fill=gray!8, draw=black!20, line width=1pt, rounded corners=5pt] (0,0) rectangle (10,6);
\node[anchor=north west, font=\normalsize\bfseries] at (0.3,5.7) {Evaluation Metrics Dashboard};

% Time series plots (simplified)
\draw[fill=white, draw=dashblue!50!black, line width=1pt, rounded corners=3pt] (0.5,4.5) rectangle (4.5,5.5);
\node[anchor=center, font=\small\bfseries] at (2.5,5.0) {Correctness Trend};

\draw[fill=white, draw=dashgreen!50!black, line width=1pt, rounded corners=3pt] (5.5,4.5) rectangle (9.5,5.5);
\node[anchor=center, font=\small\bfseries] at (7.5,5.0) {Faithfulness Trend};

\draw[fill=white, draw=dashorange!50!black, line width=1pt, rounded corners=3pt] (0.5,2.5) rectangle (4.5,3.5);
\node[anchor=center, font=\small\bfseries] at (2.5,3.0) {Latency Trend};

\draw[fill=white, draw=dashred!50!black, line width=1pt, rounded corners=3pt] (5.5,2.5) rectangle (9.5,3.5);
\node[anchor=center, font=\small\bfseries] at (7.5,3.0) {Cost Trend};

% Trend indicators
\node[font=\Large\bfseries, color=dashgreen!80!black] at (4.2,5.0) {$\uparrow$};
\node[font=\Large\bfseries, color=dashred!80!black] at (9.2,5.0) {$\downarrow$};
\node[font=\Large\bfseries, color=dashgreen!80!black] at (4.2,3.0) {$\uparrow$};
\node[font=\Large\bfseries, color=dashgreen!80!black] at (9.2,3.0) {$\downarrow$};
\end{tikzpicture}
\end{llmfigbox}
