...
\pgfmathsetmacro{\axislabelxleft}{\startx-0.8}
...
% Legend box
\draw[fill=white, draw=black!30, line width=0.8pt, rounded corners=4pt] (9.2, 0.2) rectangle (11.5, 2.8);
\node[anchor=west, font=\normalsize\bfseries, text=black!90] at (9.4, 2.4) {Coverage Status:};
\draw[fill=coverageblue!70, draw=coverageblue!90!black, line width=1.2pt, rounded corners=3pt] (9.4, 1.7) rectangle (9.9, 2.1);
\node[anchor=west, font=\normalsize] at (10.1, 1.9) {Tested};
\draw[fill=gridgray!50, draw=black!20, line width=0.8pt, rounded corners=3pt] (9.4, 1.0) rectangle (9.9, 1.4);
\node[anchor=west, font=\normalsize] at (10.1, 1.2) {Not tested};
