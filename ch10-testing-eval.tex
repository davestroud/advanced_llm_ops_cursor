...
% Dashboard layout - even larger and more spacious
\draw[fill=gray!5, draw=black!25, line width=1.2pt, rounded corners=6pt] (0,0) rectangle (18,12);
\node[anchor=north west, font=\large\bfseries, text=black!90] at (0.6,11.4) {Evaluation Metrics Dashboard};

% Top row - Correctness Trend (left) - even larger box with scale
\draw[fill=white, draw=dashblue!60!black, line width=1.2pt, rounded corners=4pt] (0.8,8.5) rectangle (8.2,10.8);
\node[anchor=north west, font=\normalsize\bfseries, text=dashblue!90!black] at (1.0,10.6) {Correctness Trend};
% Y-axis scale labels
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,9.0) {0.95};
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,8.8) {0.90};
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,8.6) {0.85};
% Simple upward trend line - adjusted for larger box with visible scale
\draw[dashblue!80!black, line width=3pt] (1.3,8.7) -- (2.5,8.75) -- (3.7,8.8) -- (4.9,8.85) -- (6.1,8.9) -- (7.3,8.95);
% Grid lines - adjusted for larger box
\foreach \x in {1.3,2.5,3.7,4.9,6.1,7.3} {
  \draw[gray!30, line width=0.3pt] (\x,8.6) -- (\x,9.0);
}
\foreach \y in {8.7,8.8,8.9,9.0} {
  \draw[gray!30, line width=0.3pt] (1.3,\y) -- (7.3,\y);
}
% Value indicator - larger font
\node[anchor=east, font=\normalsize\bfseries, text=dashblue!90!black] at (7.8,8.85) {0.92 $\uparrow$};
% X-axis time labels
\node[anchor=center, font=\tiny, text=black!50] at (2.9,8.5) {Week 1};
\node[anchor=center, font=\tiny, text=black!50] at (5.3,8.5) {Week 2};
\node[anchor=center, font=\tiny, text=black!50] at (7.3,8.5) {Week 3};

% Top row - Faithfulness Trend (right) - even larger box with scale
\draw[fill=white, draw=dashgreen!60!black, line width=1.2pt, rounded corners=4pt] (9.8,8.5) rectangle (17.2,10.8);
\node[anchor=north west, font=\normalsize\bfseries, text=dashgreen!90!black] at (10.0,10.6) {Faithfulness Trend};
% Y-axis scale labels
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,9.0) {0.95};
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,8.8) {0.90};
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,8.6) {0.85};
% Simple downward trend line - adjusted for larger box with visible scale
\draw[dashgreen!80!black, line width=3pt] (10.3,9.0) -- (11.5,8.95) -- (12.7,8.9) -- (13.9,8.85) -- (15.1,8.8) -- (16.3,8.75);
% Grid lines - adjusted for larger box
...
% Value indicator - larger font
\node[anchor=east, font=\normalsize\bfseries, text=dashgreen!90!black] at (16.8,8.85) {0.88 $\downarrow$};
% X-axis time labels
\node[anchor=center, font=\tiny, text=black!50] at (11.9,8.5) {Week 1};
\node[anchor=center, font=\tiny, text=black!50] at (14.3,8.5) {Week 2};
\node[anchor=center, font=\tiny, text=black!50] at (16.3,8.5) {Week 3};

% Bottom row - Latency Trend (left) - even larger box with scale
\draw[fill=white, draw=dashorange!60!black, line width=1.2pt, rounded corners=4pt] (0.8,5.2) rectangle (8.2,7.5);
\node[anchor=north west, font=\normalsize\bfseries, text=dashorange!90!black] at (1.0,7.3) {Latency Trend};
% Y-axis scale labels (latency in seconds)
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,6.5) {1.5s};
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,6.2) {1.2s};
\node[anchor=east, font=\footnotesize, text=black!60] at (1.0,5.9) {0.9s};
% Simple downward trend line (improving = lower latency) - adjusted for larger box
\draw[dashorange!80!black, line width=3pt] (1.3,6.4) -- (2.5,6.3) -- (3.7,6.2) -- (4.9,6.1) -- (6.1,6.0) -- (7.3,5.95);
% Grid lines - adjusted for larger box
\foreach \x in {1.3,2.5,3.7,4.9,6.1,7.3} {
  \draw[gray!30, line width=0.3pt] (\x,5.8) -- (\x,6.5);
}
\foreach \y in {6.0,6.2,6.4} {
  \draw[gray!30, line width=0.3pt] (1.3,\y) -- (7.3,\y);
}
% Value indicator - larger font
\node[anchor=east, font=\normalsize\bfseries, text=dashorange!90!black] at (7.8,6.15) {1.1s $\downarrow$};
% X-axis time labels
\node[anchor=center, font=\tiny, text=black!50] at (2.9,5.2) {Week 1};
\node[anchor=center, font=\tiny, text=black!50] at (5.3,5.2) {Week 2};
\node[anchor=center, font=\tiny, text=black!50] at (7.3,5.2) {Week 3};

% Bottom row - Cost Trend (right) - even larger box with scale
\draw[fill=white, draw=dashred!60!black, line width=1.2pt, rounded corners=4pt] (9.8,5.2) rectangle (17.2,7.5);
\node[anchor=north west, font=\normalsize\bfseries, text=dashred!90!black] at (10.0,7.3) {Cost Trend};
% Y-axis scale labels (cost in dollars)
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,6.5) {\$0.06};
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,6.2) {\$0.05};
\node[anchor=east, font=\footnotesize, text=black!60] at (10.0,5.9) {\$0.04};
% Simple downward trend line (improving = lower cost) - adjusted for larger box
\draw[dashred!80!black, line width=3pt] (10.3,6.4) -- (11.5,6.3) -- (12.7,6.2) -- (13.9,6.1) -- (15.1,6.0) -- (16.3,5.95);
% Grid lines - adjusted for larger box
\foreach \x in {10.3,11.5,12.7,13.9,15.1,16.3} {
  \draw[gray!30, line width=0.3pt] (\x,5.8) -- (\x,6.5);
}
...
% Value indicator - larger font
\node[anchor=east, font=\normalsize\bfseries, text=dashred!90!black] at (16.8,6.15) {\$0.04 $\downarrow$};
% X-axis time labels
\node[anchor=center, font=\tiny, text=black!50] at (11.9,5.2) {Week 1};
\node[anchor=center, font=\tiny, text=black!50] at (14.3,5.2) {Week 2};
\node[anchor=center, font=\tiny, text=black!50] at (16.3,5.2) {Week 3};
