...
\begin{tikzpicture}[
  ...
  note/.style={font=\small, text=black!70, align=left}
]

% Lanes
\node[lane, minimum width=0.95\linewidth, minimum height=26mm] (inglane) {};
\node[lane, minimum width=0.95\linewidth, minimum height=30mm, below=8mm of inglane] (querylane) {};
