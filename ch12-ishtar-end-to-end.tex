...
Fig.~\ref{fig:ishtar-architecture-ch12} depicts the end-to-end flows. The diagram is intentionally operational: it shows where persistence boundaries exist, where latency budgets apply, and where safety checks are enforced.
...
\label{tab:ch12_ishtar_outcomes}
\end{table}
