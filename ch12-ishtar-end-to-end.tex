...
\begin{tikzpicture}[
  font=\small,
  box/.style={draw=none, rounded corners=4pt, fill=black!2, align=center, minimum height=8mm, inner sep=2pt},
  lane/.style={draw=none, rounded corners=6pt, fill=black!1},
