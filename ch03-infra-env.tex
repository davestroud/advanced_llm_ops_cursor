...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\tiny\bfseries, color=orange!70!black, right=0.1cm of gpu1c] {Auto\\Scale};
    ...
    \node[font=\tiny\bfseries, color=gray!70, right=2.5cm of az2.east] {DR Region\\via IaC};
