...
\begin{tcolorbox}[
  title={\textbf{Best Practices for IaC in LLMOps}},
  colback=purple!5,
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    gpu/.style={rectangle, draw=orange!70!black, fill=orange!15, thick,
      rounded corners=3pt, minimum width=1.55cm, minimum height=0.72cm, align=center, font=\footnotesize},
    service/.style={rectangle, draw=teal!60!black, fill=teal!10, thick,
      rounded corners=3pt, minimum width=1.9cm, minimum height=0.78cm, align=center, font=\footnotesize},
    security/.style={rectangle, draw=red!60!black, fill=red!10, thick,
      rounded corners=3pt, minimum width=1.7cm, minimum height=0.72cm, align=center, font=\footnotesize\bfseries},
    network/.style={rectangle, draw=cyan!60!black, fill=cyan!10, thick,
      rounded corners=3pt, minimum width=2.9cm, minimum height=0.95cm, align=center, font=\footnotesize\bfseries},
    ...
    \node[font=\footnotesize\bfseries, color=orange!70!black, right=0.35cm of gpu1c, align=center] {Auto\\Scale};
    ...
    \node[font=\footnotesize\bfseries, color=cyan!70!black, below=2pt of priv.south] {Private Subnets};
    ...
    \node[font=\footnotesize\bfseries, color=gray!70, right=0.35cm of dr.east, align=center] {DR Region\\via IaC};
    ...
    \node[font=\footnotesize, right=0.15cm of leg1.east, anchor=west] {GPU Nodes (Auto-scaling)};

    \node[service, below=0.22cm of leg1.south west, anchor=north west, minimum width=1.2cm] (leg2) {};
    \node[font=\footnotesize, right=0.15cm of leg2.east, anchor=west] {Managed Services};

    \node[security, below=0.22cm of leg2.south west, anchor=north west, minimum width=1.2cm] (leg3) {};
    \node[font=\footnotesize, right=0.15cm of leg3.east, anchor=west] {Security \& IAM};
...
\begin{tikzpicture}[
  ...
  res/.style={rectangle, rounded corners=2pt, draw=black!70, thick, minimum width=8mm, minimum height=5mm, font=\footnotesize, align=center},
...
\node[k8s, minimum width=2.2cm, minimum height=0.7cm, label={[font=\footnotesize\bfseries, above=0.1cm]K8s}] (k8sA) at ($(vpcA.center) + (0, -0.2cm)$) {};
...
\node[k8s, minimum width=2.2cm, minimum height=0.7cm, label={[font=\footnotesize\bfseries, above=0.1cm]On-Prem K8s}] (k8sBprem) at ($(premB.center) + (0, 0.1cm)$) {};
...
\node[k8s, minimum width=2.2cm, minimum height=0.7cm, label={[font=\footnotesize\bfseries, above=0.1cm]Cloud K8s}] (k8sBcloud) at ($(vpcB.center) + (0, -0.2cm)$) {};
...
\draw[arrow, gray!70, dashed, line width=1.2pt] (vpnL) -- node[font=\footnotesize, align=center, midway, above] {Direct\\Connect} (vpnR);
...
\node[k8s, minimum width=2cm, minimum height=0.7cm, label={[font=\footnotesize\bfseries, above=0.1cm]K8s A}] (k8sC1) at ($(vpcC1.center) + (0, 0.1cm)$) {};
...
\node[k8s, minimum width=2cm, minimum height=0.7cm, label={[font=\footnotesize\bfseries, above=0.1cm]K8s B}] (k8sC2) at ($(vpcC2.center) + (0, 0.1cm)$) {};
...
\draw[arrow, gray!70, dashed, line width=1.2pt] (k8sC1) -- node[font=\footnotesize, align=center, midway, above, sloped] {spillover/\\failover} (k8sC2);
...
\node[font=\footnotesize, right=0.15cm of L1.east, anchor=west] {Cloud/Region};

\node[vpc, minimum width=8mm, minimum height=5mm] (L2) at ($(L1.east) + (1cm, 0)$) {};
\node[font=\footnotesize, right=0.15cm of L2.east, anchor=west] {VPC};

\node[k8s, minimum width=8mm, minimum height=5mm] (L3) at ($(L2.east) + (1cm, 0)$) {};
\node[font=\footnotesize, right=0.15cm of L3.east, anchor=west] {K8s};

\node[gpu, minimum width=8mm, minimum height=5mm] (L4) at ($(L3.east) + (1cm, 0)$) {};
\node[font=\footnotesize, right=0.15cm of L4.east, anchor=west] {GPU Node};

\node[lb, minimum width=8mm, minimum height=5mm] (L5) at ($(L1) + (0, -0.5cm)$) {};
\node[font=\footnotesize, right=0.15cm of L5.east, anchor=west] {API GW/LB};

\node[gw, minimum width=8mm, minimum height=5mm] (L6) at ($(L2) + (0, -0.5cm)$) {};
\node[font=\footnotesize, right=0.15cm of L6.east, anchor=west] {VPN/Direct Connect};

\node[store, minimum width=8mm, minimum height=5mm] (L7) at ($(L3) + (0, -0.5cm)$) {};
\node[font=\footnotesize, right=0.15cm of L7.east, anchor=west] {Object/Vector Store};
...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners, draw=black, thick, align=center, font=\small},
  gpu/.style={rectangle, rounded corners=2pt, draw=black, very thick,
              minimum width=12mm, minimum height=6mm, font=\small, align=center},
...
\begin{tcolorbox}[
  title={\textbf{Key Takeaways: Infrastructure and Environment Best Practices}},
  colback=blue!5,
  colframe=blue!40!black,
  colbacktitle=blue!20,
  coltitle=black,
