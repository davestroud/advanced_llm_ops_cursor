...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xlabel style={font=\small\bfseries, color=black!80, yshift=3pt},
      ylabel style={font=\small\bfseries, color=black!80, xshift=-3pt},
      ...
      \node[circle, fill=green!70!black, draw=white, line width=2pt, inner sep=3.5pt] at (axis cs:4,3500) {};
      \node[font=\tiny\bfseries, text=green!70!black, above=4pt] at (axis cs:4,3500) {3$\times$ gain};
      
      \node[circle, fill=orange!70!black, draw=white, line width=2pt, inner sep=3.5pt] at (axis cs:32,8500) {};
      \node[font=\tiny\bfseries, text=orange!70!black, above=4pt] at (axis cs:32,8500) {Diminishing};
      
      \node[circle, fill=red!70!black, draw=white, line width=2pt, inner sep=3.5pt] at (axis cs:64,10500) {};
      \node[font=\tiny\bfseries, text=red!70!black, above=4pt] at (axis cs:64,10500) {Saturation};
      
      % Add phase labels in shaded regions
      \node[font=\footnotesize\bfseries, text=green!70!black, align=center] at (axis cs:4,2000) {Rapid\\gain};
      \node[font=\footnotesize\bfseries, text=orange!70!black, align=center] at (axis cs:24,6000) {Diminishing\\returns};
      \node[font=\footnotesize\bfseries, text=red!70!black, align=center] at (axis cs:100,11000) {Saturation\\region};
      
      % Add batch size labels on x-axis for key points
      \node[font=\tiny, text=gray!70, below=3pt] at (axis cs:32,0) {32};
      \node[font=\tiny, text=gray!70, below=3pt] at (axis cs:64,0) {64};
      \node[font=\tiny, text=gray!70, below=3pt] at (axis cs:128,0) {128};
