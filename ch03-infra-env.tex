...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    cloud/.style={ellipse, draw=blue!70!black, fill=blue!20, line width=0.9pt,
      minimum width=45mm, minimum height=22mm, align=center, font=\small\bfseries, inner sep=6pt},
    az/.style={rectangle, draw=cyan!60!black, fill=cyan!12, line width=0.9pt,
      rounded corners=5pt, minimum width=50mm, minimum height=65mm},
    k8s/.style={rectangle, draw=purple!70!black, fill=purple!20, line width=0.9pt,
      rounded corners=3pt, minimum width=38mm, minimum height=16mm, align=center, font=\small\bfseries, inner sep=6pt},
    gpu/.style={rectangle, draw=orange!70!black, fill=orange!25, line width=0.9pt,
      rounded corners=3pt, minimum width=22mm, minimum height=11mm, align=center, font=\footnotesize, inner sep=4pt},
    service/.style={rectangle, draw=teal!70!black, fill=teal!20, line width=0.9pt,
      rounded corners=3pt, minimum width=26mm, minimum height=11mm, align=center, font=\footnotesize, inner sep=5pt},
    security/.style={rectangle, draw=red!70!black, fill=red!18, line width=0.9pt,
      rounded corners=3pt, minimum width=24mm, minimum height=11mm, align=center, font=\footnotesize\bfseries, inner sep=5pt},
    network/.style={rectangle, draw=cyan!70!black, fill=cyan!20, line width=0.9pt,
      rounded corners=3pt, minimum width=38mm, minimum height=13mm, align=center, font=\small\bfseries, inner sep=5pt},
    arrow/.style={-{Latex}, line width=0.9pt, draw=black!70},
    dasharrow/.style={-{Latex}, line width=0.9pt, dashed, draw=black!60}
  ]
    ...
    \draw[arrow, draw=orange!80!black, line width=1.4pt, <->]
      ($(gpu1c.east)+(5mm,0)$) -- ($(gpu1d.east)+(5mm,0)$);
    \node[font=\footnotesize\bfseries, color=orange!80!black, right=8mm of gpu1c, align=center] {Auto\\Scale};
    ...
    \node[draw=cyan!70!black, dashed, line width=1.1pt, rounded corners=5pt,
          fit=(az1)(az2)(az1lbl)(az2lbl), inner sep=10pt] (priv) {};
    \node[font=\footnotesize\bfseries, color=cyan!80!black, below=5pt of priv.south] {Private Subnets};

    % DR region boundary using fit
    \node[draw=gray!70, dotted, line width=1.3pt, rounded corners=8pt,
          fit=(sqs)(bedrock), inner sep=10pt] (dr) {};
    \node[font=\footnotesize\bfseries, color=gray!80, right=6mm of dr.east, align=center] {DR Region\\via IaC};
    ...
    \node[font=\footnotesize\bfseries, color=black!80, below=12mm of priv.south west, anchor=north west] (legend) {Key Features:};

    \node[gpu, below=5mm of legend.south west, anchor=north west, minimum width=16mm] (leg1) {};
    \node[font=\footnotesize, right=4mm of leg1.east, anchor=west] {GPU Nodes (Auto-scaling)};

    \node[service, below=5mm of leg1.south west, anchor=north west, minimum width=16mm] (leg2) {};
    \node[font=\footnotesize, right=4mm of leg2.east, anchor=west] {Managed Services};

    \node[security, below=5mm of leg2.south west, anchor=north west, minimum width=16mm] (leg3) {};
    \node[font=\footnotesize, right=4mm of leg3.east, anchor=west] {Security \& IAM};
