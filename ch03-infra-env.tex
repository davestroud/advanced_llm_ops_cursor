...
\centering
\begin{llmfigbox}
% Professional color definitions matching Transformer diagram style
...
\begin{tikzpicture}[
  ...
  lbl/.style={font=\normalsize\bfseries, inner sep=4pt, text=black!95},
  res/.style={rectangle, rounded corners=5pt, draw=black!75, line width=1pt, minimum width=20mm, minimum height=11mm, font=\small\bfseries, align=center},
  arrow/.style={-{Latex}, line width=1.8pt, draw=black!80},
  cloud/.style={box, fill=cloudblue!20, draw=cloudblue!85!black, line width=1.3pt, minimum width=46mm, minimum height=48mm, inner sep=7pt},
  vpc/.style={box, fill=vpccyan!25, draw=vpccyan!80!black, line width=1.1pt, inner sep=6pt},
  onprem/.style={box, fill=onpremgray!20, draw=onpremgray!80!black, line width=1.3pt, minimum width=46mm, minimum height=48mm, inner sep=7pt},
  k8s/.style={box, fill=k8sgreen!25, draw=k8sgreen!80!black, line width=1.1pt, inner sep=6pt},
  lb/.style={res, fill=apiorange!30, draw=apiorange!80!black, minimum width=26mm, minimum height=13mm},
  gw/.style={res, fill=vpnteal!30, draw=vpnteal!80!black, minimum width=22mm, minimum height=13mm},
  gpu/.style={res, fill=gpupurple!30, draw=gpupurple!80!black, minimum width=20mm, minimum height=11mm},
  store/.style={res, fill=storeyellow!30, draw=storeyellow!80!black, minimum width=28mm, minimum height=13mm}
]

% ================== (A) CLOUD-NATIVE (Top) ==================
\node[cloud, label={[lbl, above=10mm]Cloud-Native}] (cloudA) at (0, 80mm) {};
\node[vpc, minimum width=44mm, minimum height=46mm] (vpcA) at (cloudA.center) {};
\node[font=\small\bfseries, above=4mm of vpcA.north] {VPC};
\node[lb, align=center] (apigwA) at ($(vpcA.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sA) at ($(vpcA.center) + (0, 2mm)$) {};
\node[font=\small\bfseries, above=4mm of k8sA.north] {K8s Cluster};
\node[gpu] (gpuA1) at ($(k8sA.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuA2) at ($(k8sA.south) + (14mm, -14mm)$) {GPU};
\node[store, align=center] (objA) at ($(vpcA.south) + (0, -16mm)$) {Object\\Store};

\draw[arrow, color=apiorange!90!black] (apigwA) -- (k8sA);
\draw[arrow, color=gpupurple!90!black] (k8sA) -- (objA);

% ================== (B) HYBRID (Middle) ==================
\node[onprem, label={[lbl, above=10mm]Hybrid}] (premB) at (-42mm, 0) {};
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sBprem) at ($(premB.center) + (0, 8mm)$) {};
\node[font=\small\bfseries, above=4mm of k8sBprem.north] {On-Prem K8s};
\node[gpu] (gpuB1) at ($(k8sBprem.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuB2) at ($(k8sBprem.south) + (14mm, -14mm)$) {GPU};
\node[store, align=center] (vecB) at ($(premB.south) + (0, -16mm)$) {Vector\\DB};

\node[cloud] (cloudB) at (42mm, 0) {};
\node[vpc, minimum width=44mm, minimum height=46mm] (vpcB) at (cloudB.center) {};
\node[font=\small\bfseries, above=4mm of vpcB.north] {Cloud VPC};
\node[lb, align=center] (apigwB) at ($(vpcB.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sBcloud) at ($(vpcB.center) + (0, 2mm)$) {};
\node[font=\small\bfseries, above=4mm of k8sBcloud.north] {Cloud K8s};
\node[gpu] (gpuB3) at ($(k8sBcloud.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuB4) at ($(k8sBcloud.south) + (14mm, -14mm)$) {GPU};

\node[gw, align=center] (vpnL) at ($(premB.east) + (10mm, 0)$) {VPN};
\node[gw, align=center] (vpnR) at ($(cloudB.west) + (-10mm, 0)$) {VPN};

\draw[arrow, color=vpnteal!90!black] (k8sBprem) -- (vpnL);
\draw[arrow, color=vpnteal!90!black] (vpnR) -- (k8sBcloud);
\draw[arrow, color=gray!80, dashed, line width=1.8pt] (vpnL) -- node[font=\small\bfseries, align=center, midway, above, text=black!90] {Direct\\Connect} (vpnR);
...
\node[cloud, label={[lbl, above=10mm]Multi-Cluster / Multi-Region}] (cloudC) at (0, -80mm) {};
\node[lb, align=center] (glbC) at ($(cloudC.north) + (0, -10mm)$) {Global\\LB/DNS};

\node[vpc, minimum width=40mm, minimum height=46mm] (vpcC1) at ($(cloudC.center) + (-18mm, -5mm)$) {};
\node[font=\small\bfseries, above=4mm of vpcC1.north] {Region A};
\node[k8s, minimum width=36mm, minimum height=16mm] (k8sC1) at ($(vpcC1.center) + (0, 8mm)$) {};
\node[font=\small\bfseries, above=4mm of k8sC1.north] {K8s A};
\node[gpu] (gpuC1) at ($(k8sC1.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuC2) at ($(k8sC1.south) + (14mm, -14mm)$) {GPU};

\node[vpc, minimum width=40mm, minimum height=46mm] (vpcC2) at ($(cloudC.center) + (18mm, -5mm)$) {};
\node[font=\small\bfseries, above=4mm of vpcC2.north] {Region B};
\node[k8s, minimum width=36mm, minimum height=16mm] (k8sC2) at ($(vpcC2.center) + (0, 8mm)$) {};
\node[font=\small\bfseries, above=4mm of k8sC2.north] {K8s B};
\node[gpu] (gpuC3) at ($(k8sC2.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuC4) at ($(k8sC2.south) + (14mm, -14mm)$) {GPU};

\draw[arrow, color=apiorange!90!black] (glbC) -- ($(glbC) + (-18mm, -16mm)$) -- (k8sC1);
\draw[arrow, color=apiorange!90!black] (glbC) -- ($(glbC) + (18mm, -16mm)$) -- (k8sC2);
\draw[arrow, color=gray!80, dashed, line width=1.8pt] (k8sC1) -- node[font=\small\bfseries, align=center, midway, above, sloped, text=black!90] {spillover/\\failover} (k8sC2);

% ================== Professional legend (below all patterns) ==================
\node[box, fill=white!99, draw=black!50, rounded corners=6pt, line width=1.2pt, minimum width=0.95\linewidth, minimum height=22mm, inner sep=7pt] (legend) at (0, -110mm) {};

\node[cloud, minimum width=20mm, minimum height=13mm] (L1) at ($(legend.west) + (20mm, 9mm)$) {};
\node[font=\small\bfseries, right=7mm of L1.east, anchor=west, text=black!90] {Cloud/Region};

\node[vpc, minimum width=20mm, minimum height=13mm] (L2) at ($(L1.east) + (26mm, 0)$) {};
\node[font=\small\bfseries, right=7mm of L2.east, anchor=west, text=black!90] {VPC};

\node[onprem, minimum width=20mm, minimum height=13mm] (L8) at ($(L2.east) + (26mm, 0)$) {};
\node[font=\small\bfseries, right=7mm of L8.east, anchor=west, text=black!90] {On-Prem};

\node[k8s, minimum width=20mm, minimum height=13mm] (L3) at ($(L8.east) + (26mm, 0)$) {};
\node[font=\small\bfseries, right=7mm of L3.east, anchor=west, text=black!90] {K8s};

\node[gpu, minimum width=20mm, minimum height=13mm] (L4) at ($(L1) + (0, -14mm)$) {};
\node[font=\small\bfseries, right=7mm of L4.east, anchor=west, text=black!90] {GPU Node};

\node[lb, minimum width=20mm, minimum height=13mm] (L5) at ($(L2) + (0, -14mm)$) {};
\node[font=\small\bfseries, right=7mm of L5.east, anchor=west, text=black!90] {API GW/LB};

\node[gw, minimum width=20mm, minimum height=13mm] (L6) at ($(L8) + (0, -14mm)$) {};
\node[font=\small\bfseries, right=7mm of L6.east, anchor=west, text=black!90] {VPN/Direct Connect};

\node[store, minimum width=20mm, minimum height=13mm] (L7) at ($(L3) + (0, -14mm)$) {};
\node[font=\small\bfseries, right=7mm of L7.east, anchor=west, text=black!90] {Object/Vector Store};
...
\begin{llmfigbox}
% Color definitions
\definecolor{onpremgray}{RGB}{128,128,128}
\definecolor{gpupurple}{RGB}{123,88,163}
\definecolor{embedyellow}{RGB}{255,193,7}
\definecolor{vpnteal}{RGB}{0,128,128}
\definecolor{cloudblue}{RGB}{44,102,146}
\definecolor{nodegreen}{RGB}{34,139,96}
\definecolor{servingorange}{RGB}{201,111,29}
\definecolor{iacblue}{RGB}{0,102,204}
\begin{tikzpicture}[
  font=\small,
  >=Stealth,
  node distance=9mm and 12mm,
  box/.style={rectangle, rounded corners=5pt, draw=none, align=center},
  gpu/.style={rectangle, rounded corners=4pt, draw=none,
              minimum width=16mm, minimum height=9mm, font=\small\bfseries, align=center},
  arrow/.style={-{Latex}, line width=1.2pt},
  lbl/.style={font=\small\bfseries}
]

% ============= On-Prem =============
\node[box, fill=onpremgray!15, minimum width=42mm, minimum height=32mm,
      label={[lbl]above:{\textbf{On-Prem (L4 Cluster)}}}] (onprem) {};
\node[gpu, fill=gpupurple!20] (l4a) at ([yshift=6mm]onprem.center) {L4 GPU};
\node[gpu, fill=gpupurple!20, right=5mm of l4a] (l4b) {L4 GPU};
\node[box, fill=embedyellow!20, below=6mm of onprem.center, align=center, minimum width=30mm, minimum height=11mm] (embed) {Embeddings /\\NER Tagging};
\draw[arrow, color=black!70] (l4a) -- (embed);
\draw[arrow, color=black!70] (l4b) -- (embed);

% VPN to cloud
\node[box, fill=vpnteal!20, minimum width=18mm, minimum height=11mm,
      right=12mm of onprem.east] (vpn) {VPN};

\draw[arrow, color=vpnteal!70!black] (onprem.east) -- (vpn.west);

% ============= Cloud Baseline A100 =============
\node[box, fill=cloudblue!15, minimum width=52mm, minimum height=50mm,
      right=16mm of vpn, label={[lbl]above:{\textbf{Cloud (AWS EKS)}}}] (cloud) {};

\node[box, fill=nodegreen!15, minimum width=46mm, minimum height=16mm,
      above=5mm of cloud.south, anchor=south, label={[font=\small\bfseries]above:{Baseline Node Group}}] (a100group) {};
\node[gpu, fill=gpupurple!20] (a100a) at ([xshift=-13mm]a100group.center) {A100};
\node[gpu, fill=gpupurple!20] (a100b) at ([xshift=13mm]a100group.center) {A100};

\node[box, fill=nodegreen!15, minimum width=46mm, minimum height=16mm,
      above=5mm of a100group.north, anchor=south, label={[font=\small\bfseries]above:{Autoscaling Node Group}}] (h100group) {};
\node[gpu, fill=gpupurple!30] (h100a) at ([xshift=-13mm]h100group.center) {H100};
\node[gpu, fill=gpupurple!30] (h100b) at ([xshift=13mm]h100group.center) {H100};

% Serving pods
\node[box, fill=servingorange!20, above=5mm of h100group.north, anchor=south,
      minimum width=46mm, minimum height=13mm] (serving) {Model Serving Pods (TGI / vLLM)};

% Terraform + K8s control
\node[box, fill=iacblue!20, minimum width=32mm, minimum height=11mm,
      above=7mm of serving.north] (iac) {Terraform + ArgoCD + K8s Autoscaling};

\draw[arrow, color=servingorange!70!black] (a100a.north) -- (serving.south);
\draw[arrow, color=servingorange!70!black] (h100a.north) -- (serving.south);
\draw[arrow, color=iacblue!70!black] (iac.south) -- (serving.north);

% VPN arrow into cloud workloads
\draw[arrow, color=vpnteal!70!black] (vpn.east) -- (cloud.west);
...
\node[gpu, fill=gpupurple!20, minimum width=13mm, minimum height=9mm, label={[font=\small]right:L4 / A100 GPU}] (L1) at ($(legend.west) + (10mm, 0)$) {};
\node[gpu, fill=gpupurple!30, minimum width=13mm, minimum height=9mm, label={[font=\small]right:H100 GPU}] (L2) at ($(L1.east) + (28mm, 0)$) {};
\node[box, fill=servingorange!20, minimum width=13mm, minimum height=9mm, label={[font=\small]right:Serving Pods}] (L3) at ($(L2.east) + (28mm, 0)$) {};
\node[box, fill=iacblue!20, minimum width=13mm, minimum height=9mm, label={[font=\small]right:IaC / Control Plane}] (L4) at ($(L3.east) + (28mm, 0)$) {};
