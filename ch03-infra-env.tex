...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \node[font=\small\bfseries, text=green!70!black, above=5pt] at (axis cs:4,3500) {3$\times$ gain};
      ...
      % Add phase labels in shaded regions (larger font for readability)
      \node[font=\small\bfseries, text=green!70!black, align=center] at (axis cs:4,2000) {Rapid\\gain};
