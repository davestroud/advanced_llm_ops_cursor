...
\node[vpc, minimum width=44mm, minimum height=46mm, label={[font=\small\bfseries, above=5mm]VPC}] (vpcA) at (cloudA.center) {};
\node[lb, align=center] (apigwA) at ($(vpcA.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm, label={[font=\small\bfseries, above=5mm]K8s Cluster}] (k8sA) at ($(vpcA.center) + (0, 2mm)$) {};
...
\node[k8s, minimum width=40mm, minimum height=16mm, label={[font=\small\bfseries, above=5mm]On-Prem K8s}] (k8sBprem) at ($(premB.center) + (0, 8mm)$) {};
...
\node[vpc, minimum width=44mm, minimum height=46mm, label={[font=\small\bfseries, above=5mm]Cloud VPC}] (vpcB) at (cloudB.center) {};
\node[lb, align=center] (apigwB) at ($(vpcB.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm, label={[font=\small\bfseries, above=5mm]Cloud K8s}] (k8sBcloud) at ($(vpcB.center) + (0, 2mm)$) {};
...
\node[vpc, minimum width=40mm, minimum height=46mm, label={[font=\small\bfseries, above=5mm]Region A}] (vpcC1) at ($(cloudC.center) + (-18mm, -5mm)$) {};
\node[k8s, minimum width=36mm, minimum height=16mm, label={[font=\small\bfseries, above=5mm]K8s A}] (k8sC1) at ($(vpcC1.center) + (0, 8mm)$) {};
\node[gpu] (gpuC1) at ($(k8sC1.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuC2) at ($(k8sC1.south) + (14mm, -14mm)$) {GPU};

\node[vpc, minimum width=40mm, minimum height=46mm, label={[font=\small\bfseries, above=5mm]Region B}] (vpcC2) at ($(cloudC.center) + (18mm, -5mm)$) {};
\node[k8s, minimum width=36mm, minimum height=16mm, label={[font=\small\bfseries, above=5mm]K8s B}] (k8sC2) at ($(vpcC2.center) + (0, 8mm)$) {};
