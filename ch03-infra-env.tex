...
\node[vpc, minimum width=44mm, minimum height=46mm] (vpcA) at (cloudA.center) {VPC};
\node[lb, align=center] (apigwA) at ($(vpcA.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sA) at ($(vpcA.center) + (0, 2mm)$) {K8s Cluster};
...
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sBprem) at ($(premB.center) + (0, 8mm)$) {On-Prem K8s};
...
\node[vpc, minimum width=44mm, minimum height=46mm] (vpcB) at (cloudB.center) {Cloud VPC};
\node[lb, align=center] (apigwB) at ($(vpcB.north) + (0, -11mm)$) {API\\Gateway};
\node[k8s, minimum width=40mm, minimum height=16mm] (k8sBcloud) at ($(vpcB.center) + (0, 2mm)$) {Cloud K8s};
...
\node[vpc, minimum width=40mm, minimum height=46mm] (vpcC1) at ($(cloudC.center) + (-18mm, -5mm)$) {Region A};
\node[k8s, minimum width=36mm, minimum height=16mm] (k8sC1) at ($(vpcC1.center) + (0, 8mm)$) {K8s A};
\node[gpu] (gpuC1) at ($(k8sC1.south) + (-14mm, -14mm)$) {GPU};
\node[gpu] (gpuC2) at ($(k8sC1.south) + (14mm, -14mm)$) {GPU};

\node[vpc, minimum width=40mm, minimum height=46mm] (vpcC2) at ($(cloudC.center) + (18mm, -5mm)$) {Region B};
\node[k8s, minimum width=36mm, minimum height=16mm] (k8sC2) at ($(vpcC2.center) + (0, 8mm)$) {K8s B};
