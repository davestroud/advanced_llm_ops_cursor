...
\draw[arrow, gray!70, dashed, line width=1.2pt] (vpnL) -- node[font=\small, align=center, midway, above] {\strut Direct\\\strut Connect} (vpnR);
...
\draw[arrow, gray!70, dashed, line width=1.2pt] (k8sC1) -- node[font=\small, align=center, midway, above, sloped] {\strut spillover/\\\strut failover} (k8sC2);

% ================== Clean legend (below all patterns) ==================
\node[box, fill=white!95, draw=none, rounded corners=4pt, minimum width=0.95\linewidth, minimum height=16mm, inner sep=4pt] (legend) at (0, -100mm) {};
