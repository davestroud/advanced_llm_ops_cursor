...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners=5pt, draw=black!60, line width=0.8pt, align=center},
  lbl/.style={font=\small\bfseries, inner sep=2pt},
  res/.style={rectangle, rounded corners=4pt, draw=black!60, line width=0.8pt, minimum width=14mm, minimum height=8mm, font=\small\bfseries, align=center},
  arrow/.style={-{Latex}, line width=1.2pt, draw=black!70},
  cloud/.style={box, fill=cloudblue!15, draw=cloudblue!70!black, line width=1pt, minimum width=38mm, minimum height=40mm, inner sep=5pt},
  vpc/.style={box, fill=vpccyan!20, draw=vpccyan!70!black, line width=0.9pt, inner sep=4pt},
  onprem/.style={box, fill=onpremgray!15, draw=onpremgray!70!black, line width=1pt, minimum width=38mm, minimum height=40mm, inner sep=5pt},
  k8s/.style={box, fill=k8sgreen!20, draw=k8sgreen!70!black, line width=0.9pt, inner sep=4pt},
  lb/.style={res, fill=apiorange!25, draw=apiorange!70!black},
  gw/.style={res, fill=vpnteal!25, draw=vpnteal!70!black},
  gpu/.style={res, fill=gpupurple!25, draw=gpupurple!70!black},
  store/.style={res, fill=storeyellow!25, draw=storeyellow!70!black}
]

% ================== (A) CLOUD-NATIVE (Top) ==================
\node[cloud, label={[lbl, above=6mm]Cloud-Native}] (cloudA) at (0, 70mm) {};
\node[vpc, minimum width=36mm, minimum height=38mm, label={[font=\small\bfseries, above=3mm]VPC}] (vpcA) at (cloudA.center) {};
\node[lb, minimum width=20mm, minimum height=10mm, align=center] (apigwA) at ($(vpcA.north) + (0, -8mm)$) {\strut API\\\strut GW};
\node[k8s, minimum width=32mm, minimum height=12mm, label={[font=\small\bfseries, above=3mm]K8s}] (k8sA) at ($(vpcA.center) + (0, -1mm)$) {};
\node[gpu, minimum width=16mm, align=center] (gpuA1) at ($(k8sA.south) + (-10mm, -10mm)$) {GPU};
\node[gpu, minimum width=16mm, align=center] (gpuA2) at ($(k8sA.south) + (10mm, -10mm)$) {GPU};
\node[store, minimum width=22mm, align=center] (objA) at ($(vpcA.south) + (0, -12mm)$) {\strut Object\\\strut Store};

\draw[arrow, color=apiorange!80!black] (apigwA) -- (k8sA);
\draw[arrow, color=gpupurple!80!black] (k8sA) -- (objA);
...
\node[gpu, minimum width=16mm, align=center] (gpuB1) at ($(k8sBprem.south) + (-10mm, -10mm)$) {GPU};
\node[gpu, minimum width=16mm, align=center] (gpuB2) at ($(k8sBprem.south) + (10mm, -10mm)$) {GPU};
\node[store, minimum width=22mm, align=center] (vecB) at ($(premB.south) + (0, -12mm)$) {\strut Vector\\\strut DB};
...
\node[lb, minimum width=20mm, minimum height=10mm, align=center] (apigwB) at ($(vpcB.north) + (0, -8mm)$) {\strut API\\\strut GW};
...
\node[gpu, minimum width=16mm, align=center] (gpuB3) at ($(k8sBcloud.south) + (-10mm, -10mm)$) {GPU};
\node[gpu, minimum width=16mm, align=center] (gpuB4) at ($(k8sBcloud.south) + (10mm, -10mm)$) {GPU};

\node[gw, minimum width=18mm, minimum height=10mm, align=center] (vpnL) at ($(premB.east) + (6mm, 0)$) {VPN};
\node[gw, minimum width=18mm, minimum height=10mm, align=center] (vpnR) at ($(cloudB.west) + (-6mm, 0)$) {VPN};

\draw[arrow, color=vpnteal!80!black] (k8sBprem) -- (vpnL);
\draw[arrow, color=vpnteal!80!black] (vpnR) -- (k8sBcloud);
\draw[arrow, color=gray!70, dashed, line width=1.4pt] (vpnL) -- node[font=\small\bfseries, align=center, midway, above, text=black!80] {\strut Direct\\\strut Connect} (vpnR);
\draw[arrow, color=gpupurple!80!black] (k8sBprem) -- (vecB);
\draw[arrow, color=apiorange!80!black] (apigwB) -- (k8sBcloud);

% ================== (C) MULTI-CLUSTER (Bottom) ==================
\node[cloud, label={[lbl, above=6mm]Multi-Cluster / Multi-Region}] (cloudC) at (0, -70mm) {};
\node[lb, minimum width=22mm, minimum height=10mm, align=center] (glbC) at ($(cloudC.north) + (0, -6mm)$) {\strut Global\\\strut LB/DNS};
...
\node[gpu, minimum width=16mm, align=center] (gpuC1) at ($(k8sC1.south) + (-10mm, -10mm)$) {GPU};
\node[gpu, minimum width=16mm, align=center] (gpuC2) at ($(k8sC1.south) + (10mm, -10mm)$) {GPU};
...
\node[gpu, minimum width=16mm, align=center] (gpuC3) at ($(k8sC2.south) + (-10mm, -10mm)$) {GPU};
\node[gpu, minimum width=16mm, align=center] (gpuC4) at ($(k8sC2.south) + (10mm, -10mm)$) {GPU};

\draw[arrow, color=apiorange!80!black] (glbC) -- ($(glbC) + (-14mm, -12mm)$) -- (k8sC1);
\draw[arrow, color=apiorange!80!black] (glbC) -- ($(glbC) + (14mm, -12mm)$) -- (k8sC2);
\draw[arrow, color=gray!70, dashed, line width=1.4pt] (k8sC1) -- node[font=\small\bfseries, align=center, midway, above, sloped, text=black!80] {\strut spillover/\\\strut failover} (k8sC2);

% ================== Professional legend (below all patterns) ==================
\node[box, fill=white!98, draw=black!30, rounded corners=5pt, line width=0.8pt, minimum width=0.95\linewidth, minimum height=18mm, inner sep=5pt] (legend) at (0, -100mm) {};

\node[cloud, minimum width=16mm, minimum height=10mm] (L1) at ($(legend.west) + (16mm, 7mm)$) {};
\node[font=\small\bfseries, right=5mm of L1.east, anchor=west, text=black!80] {Cloud/Region};

\node[vpc, minimum width=16mm, minimum height=10mm] (L2) at ($(L1.east) + (22mm, 0)$) {};
\node[font=\small\bfseries, right=5mm of L2.east, anchor=west, text=black!80] {VPC};

\node[onprem, minimum width=16mm, minimum height=10mm] (L8) at ($(L2.east) + (22mm, 0)$) {};
\node[font=\small\bfseries, right=5mm of L8.east, anchor=west, text=black!80] {On-Prem};

\node[k8s, minimum width=16mm, minimum height=10mm] (L3) at ($(L8.east) + (22mm, 0)$) {};
\node[font=\small\bfseries, right=5mm of L3.east, anchor=west, text=black!80] {K8s};

\node[gpu, minimum width=16mm, minimum height=10mm] (L4) at ($(L1) + (0, -11mm)$) {};
\node[font=\small\bfseries, right=5mm of L4.east, anchor=west, text=black!80] {GPU Node};

\node[lb, minimum width=16mm, minimum height=10mm] (L5) at ($(L2) + (0, -11mm)$) {};
\node[font=\small\bfseries, right=5mm of L5.east, anchor=west, text=black!80] {API GW/LB};

\node[gw, minimum width=16mm, minimum height=10mm] (L6) at ($(L8) + (0, -11mm)$) {};
\node[font=\small\bfseries, right=5mm of L6.east, anchor=west, text=black!80] {VPN/Direct Connect};

\node[store, minimum width=16mm, minimum height=10mm] (L7) at ($(L3) + (0, -11mm)$) {};
\node[font=\small\bfseries, right=5mm of L7.east, anchor=west, text=black!80] {Object/Vector Store};
