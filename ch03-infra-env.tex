...
\begin{tikzpicture}[
  ...
  cloud/.style={box, fill=blue!20, draw=blue!70!black, minimum width=42mm, minimum height=48mm, inner sep=5pt},
  vpc/.style={box, fill=cyan!25, draw=cyan!70!black, inner sep=4pt},
  onprem/.style={box, fill=gray!18, draw=gray!70!black, minimum width=42mm, minimum height=48mm, inner sep=5pt},
...
\node (row1) at (0, 38mm) {};  % Top: Cloud-Native
\node (row2) at (0, 0) {};     % Middle: Hybrid
\node (row3) at (0, -38mm) {}; % Bottom: Multi-Cluster

% ================== (A) CLOUD-NATIVE (Top) ==================
\node[cloud, label={[lbl, above=6mm]Cloud-Native}] (cloudA) at (row1) {};
\node[vpc, minimum width=36mm, minimum height=38mm, label={[font=\footnotesize\bfseries, above=3mm]VPC}] (vpcA) at (cloudA.center) {};
...
\node[vpc, minimum width=36mm, minimum height=38mm, label={[font=\footnotesize\bfseries, above=3mm]Cloud VPC}] (vpcB) at (cloudB.center) {};
...
\node[vpc, minimum width=32mm, minimum height=38mm, label={[font=\footnotesize\bfseries, above=3mm]Region A}] (vpcC1) at ($(cloudC.center) + (-14mm, -3mm)$) {};
...
\node[vpc, minimum width=32mm, minimum height=38mm, label={[font=\footnotesize\bfseries, above=3mm]Region B}] (vpcC2) at ($(cloudC.center) + (14mm, -3mm)$) {};
...
\node[box, fill=white!95, draw=black!50, rounded corners=4pt, minimum width=0.95\linewidth, minimum height=18mm, inner sep=6pt] (legend) at ($(row3) + (0, -32mm)$) {};
...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners=4pt, draw=black!70, thick, align=center},
  gpu/.style={rectangle, rounded corners=3pt, draw=black!70, thick,
              minimum width=14mm, minimum height=8mm, font=\footnotesize, align=center},
  arrow/.style={-{Latex}, line width=0.9pt},
  lbl/.style={font=\small\bfseries}
]

% ============= On-Prem =============
\node[box, fill=gray!18, minimum width=42mm, minimum height=32mm,
...
\node[box, fill=yellow!25, below=6mm of onprem.center, align=center, minimum width=30mm, minimum height=10mm] (embed) {Embeddings /\\NER Tagging};
\draw[arrow, gray!70] (l4a) -- (embed);
\draw[arrow, gray!70] (l4b) -- (embed);

% VPN to cloud
\node[box, fill=teal!25, minimum width=16mm, minimum height=10mm,
      right=10mm of onprem.east] (vpn) {VPN};

\draw[arrow, teal!80] (onprem.east) -- (vpn.west);

% ============= Cloud Baseline A100 =============
\node[box, fill=blue!20, minimum width=52mm, minimum height=50mm,
      right=14mm of vpn, label={[lbl]above:{\textbf{Cloud (AWS EKS)}}}] (cloud) {};

\node[box, fill=green!20, minimum width=46mm, minimum height=16mm,
      above=4mm of cloud.south, anchor=south, label={[font=\footnotesize\bfseries]above:{Baseline Node Group}}] (a100group) {};
...
\node[box, fill=green!20, minimum width=46mm, minimum height=16mm,
      above=4mm of a100group.north, anchor=south, label={[font=\footnotesize\bfseries]above:{Autoscaling Node Group}}] (h100group) {};
...
\node[box, fill=orange!25, above=4mm of h100group.north, anchor=south,
      minimum width=46mm, minimum height=12mm] (serving) {Model Serving Pods (TGI / vLLM)};

% Terraform + K8s control
\node[box, fill=blue!25, minimum width=32mm, minimum height=10mm,
...
% ============= Legend =============
\node[box, fill=white!95, draw=black!50, very thick, inner sep=4pt,
      below=12mm of cloud.south, minimum width=0.9\linewidth, minimum height=14mm] (legend) {};

\node[gpu, fill=purple!25, minimum width=10mm, minimum height=6mm, label={[font=\footnotesize]right:L4 / A100 GPU}] (L1) at ($(legend.west) + (8mm, 0)$) {};
\node[gpu, fill=purple!40, minimum width=10mm, minimum height=6mm, label={[font=\footnotesize]right:H100 GPU}] (L2) at ($(L1.east) + (25mm, 0)$) {};
\node[box, fill=orange!25, minimum width=10mm, minimum height=6mm, label={[font=\footnotesize]right:Serving Pods}] (L3) at ($(L2.east) + (25mm, 0)$) {};
\node[box, fill=blue!25, minimum width=10mm, minimum height=6mm, label={[font=\footnotesize]right:IaC / Control Plane}] (L4) at ($(L3.east) + (25mm, 0)$) {};
