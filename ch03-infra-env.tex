...
\node[vpc, minimum width=48mm, minimum height=54mm] (vpcC1) at ($(cloudC.center) + (-32mm, -8mm)$) {Region A};
\node[k8s, minimum width=44mm, minimum height=22mm] (k8sC1) at ($(vpcC1.center) + (0, 14mm)$) {K8s A};
\node[gpu] (gpuC1) at ($(k8sC1.south) + (-18mm, -19mm)$) {GPU};
\node[gpu] (gpuC2) at ($(k8sC1.south) + (18mm, -19mm)$) {GPU};

\node[vpc, minimum width=48mm, minimum height=54mm] (vpcC2) at ($(cloudC.center) + (32mm, -8mm)$) {Region B};
\node[k8s, minimum width=44mm, minimum height=22mm] (k8sC2) at ($(vpcC2.center) + (0, 14mm)$) {K8s B};
\node[gpu] (gpuC3) at ($(k8sC2.south) + (-18mm, -19mm)$) {GPU};
\node[gpu] (gpuC4) at ($(k8sC2.south) + (18mm, -19mm)$) {GPU};
