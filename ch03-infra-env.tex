...
\draw[arrow, gray!70, dashed, line width=1.2pt] (vpnL) -- node[font=\tiny, midway, above] {Direct\\Connect} (vpnR);
...
\draw[arrow, gray!70, dashed, line width=1.2pt] (k8sC1) -- node[font=\tiny, midway, above, sloped] {spillover/\\failover} (k8sC2);
