...
% ================== SECTION HEADERS ==================
\node[header] (headerA) at (-50mm, 50mm) {Cloud-Native};
\node[header] (headerB) at (50mm, 50mm) {Hybrid};
\node[header] (headerC) at (0mm, -20mm) {Multi-Cluster / Multi-Region};

% ================== VISUAL SEPARATORS ==================
\draw[draw=black!20, line width=0.8pt, dashed] (0mm, -50mm) -- (0mm, 10mm);
\draw[draw=black!20, line width=0.8pt, dashed] (-100mm, -5mm) -- (100mm, -5mm);

% ================== (A) CLOUD-NATIVE (Top Left) ==================
\node[cloud] (cloudA) at (-50mm, 20mm) {};
...
\node[box, fill=white!99, draw=black!50, rounded corners=6pt, line width=1.2pt, minimum width=180mm, minimum height=24mm, inner sep=8pt] (legend) at (0mm, -80mm) {};
