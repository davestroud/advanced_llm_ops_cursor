...
% ================== VISUAL SEPARATORS ==================
\draw[draw=black!20, line width=0.8pt, dashed] (0mm, -70mm) -- (0mm, 20mm);
\draw[draw=black!20, line width=0.8pt, dashed] (-120mm, -10mm) -- (120mm, -10mm);

% ================== (A) CLOUD-NATIVE (Top Left) ==================
\node[cloud] (cloudA) at (-70mm, 30mm) {};
\node[vpc, minimum width=50mm, minimum height=52mm] (vpcA) at (cloudA.center) {VPC};
...
\node[gpu] (gpuA1) at ($(k8sA.south) + (-17mm, -17mm)$) {GPU};
\node[gpu] (gpuA2) at ($(k8sA.south) + (17mm, -17mm)$) {GPU};
\node[store, align=center] (objA) at ($(vpcA.south) + (0, -20mm)$) {Object\\Store};
...
\node[k8s, minimum width=46mm, minimum height=20mm] (k8sBprem) at ($(premB.center) + (0, 12mm)$) {On-Prem\\K8s};
\node[gpu] (gpuB1) at ($(k8sBprem.south) + (-17mm, -17mm)$) {GPU};
\node[gpu] (gpuB2) at ($(k8sBprem.south) + (17mm, -17mm)$) {GPU};
\node[store, align=center] (vecB) at ($(premB.south) + (0, -20mm)$) {Vector\\DB};

\node[cloud] (cloudB) at (110mm, 30mm) {};
\node[vpc, minimum width=50mm, minimum height=52mm] (vpcB) at (cloudB.center) {Cloud VPC};
\node[lb, align=center] (apigwB) at ($(vpcB.north) + (0, -14mm)$) {API\\Gateway};
\node[k8s, minimum width=46mm, minimum height=20mm] (k8sBcloud) at ($(vpcB.center) + (0, 3mm)$) {Cloud K8s};
\node[gpu] (gpuB3) at ($(k8sBcloud.south) + (-17mm, -17mm)$) {GPU};
\node[gpu] (gpuB4) at ($(k8sBcloud.south) + (17mm, -17mm)$) {GPU};

\node[gw, align=center] (vpnL) at ($(premB.east) + (15mm, 0)$) {VPN};
\node[gw, align=center] (vpnR) at ($(cloudB.west) + (-15mm, 0)$) {VPN};
...
\node[lb, align=center] (glbC) at ($(cloudC.north) + (0, -14mm)$) {Global\\LB/DNS};

\node[vpc, minimum width=46mm, minimum height=52mm] (vpcC1) at ($(cloudC.center) + (-24mm, -6mm)$) {Region A};
\node[k8s, minimum width=42mm, minimum height=20mm] (k8sC1) at ($(vpcC1.center) + (0, 12mm)$) {K8s A};
\node[gpu] (gpuC1) at ($(k8sC1.south) + (-17mm, -17mm)$) {GPU};
\node[gpu] (gpuC2) at ($(k8sC1.south) + (17mm, -17mm)$) {GPU};

\node[vpc, minimum width=46mm, minimum height=52mm] (vpcC2) at ($(cloudC.center) + (24mm, -6mm)$) {Region B};
\node[k8s, minimum width=42mm, minimum height=20mm] (k8sC2) at ($(vpcC2.center) + (0, 12mm)$) {K8s B};
\node[gpu] (gpuC3) at ($(k8sC2.south) + (-17mm, -17mm)$) {GPU};
\node[gpu] (gpuC4) at ($(k8sC2.south) + (17mm, -17mm)$) {GPU};

\draw[arrow, color=apiorange!90!black] (glbC) -- ($(glbC) + (-24mm, -20mm)$) -- (k8sC1);
\draw[arrow, color=apiorange!90!black] (glbC) -- ($(glbC) + (24mm, -20mm)$) -- (k8sC2);
