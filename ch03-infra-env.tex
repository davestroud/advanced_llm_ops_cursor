...
% ================== Row anchors (vertical stacking) ==================
\node (row1) at (0, 50mm) {};  % Top: Cloud-Native
\node (row2) at (0, 0) {};     % Middle: Hybrid
\node (row3) at (0, -50mm) {}; % Bottom: Multi-Cluster

% ================== (A) CLOUD-NATIVE (Top) ==================
\node[cloud, label={[lbl, above=6mm]Cloud-Native}] (cloudA) at (row1) {};
...
% ================== (B) HYBRID (Middle) ==================
\node[onprem, label={[lbl, above=6mm]Hybrid}] (premB) at ($(row2) + (-30mm, 0)$) {};
...
\node[cloud] (cloudB) at ($(row2) + (30mm, 0)$) {};
...
\node[cloud, label={[lbl, above=6mm]Multi-Cluster / Multi-Region}] (cloudC) at (row3) {};
...
\node[box, fill=white!95, draw=black!50, rounded corners=4pt, minimum width=0.95\linewidth, minimum height=20mm, inner sep=7pt] (legend) at ($(row3) + (0, -40mm)$) {};
