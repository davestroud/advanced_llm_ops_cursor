...
\begin{tikzpicture}[
  ...
  res/.style={rectangle, rounded corners=3pt, draw=none, minimum width=15mm, minimum height=9mm, font=\small, align=center},
  arrow/.style={-{Latex}, line width=1pt},
  cloud/.style={box, fill=blue!20, minimum width=42mm, minimum height=45mm, inner sep=5pt},
  vpc/.style={box, fill=cyan!25, inner sep=4pt},
  onprem/.style={box, fill=gray!18, minimum width=42mm, minimum height=45mm, inner sep=5pt},
  k8s/.style={box, fill=green!20, inner sep=5pt},
...
\node[box, fill=white!95, draw=none, rounded corners=4pt, minimum width=0.95\linewidth, minimum height=18mm, inner sep=5pt] (legend) at ($(row3) + (0, -32mm)$) {};
