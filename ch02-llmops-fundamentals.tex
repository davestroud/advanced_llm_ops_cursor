...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[
      ...
      >=Stealth,
      node distance=9mm,
      box/.style={draw=none, rounded corners, minimum width=34mm, minimum height=9mm, align=center, inner sep=4pt}
    ]
        ...
        \node[box, fill=gray!10, below=9mm of mha] (addnorm1) {Add \& Norm};
        \node[box, fill=gray!20, below=9mm of addnorm1] (ffn) {Feed-Forward Network};
        \node[box, fill=gray!10, below=9mm of ffn] (addnorm2) {Add \& Norm};
        \node[box, fill=gray!10, below=11mm of addnorm2] (output) {Hidden States / Next Block};

        % Arrows
        \draw[-{Latex}, line width=1pt] (input) -- (mha);
        \draw[-{Latex}, line width=1pt] (mha) -- (addnorm1);
        \draw[-{Latex}, line width=1pt] (addnorm1) -- (ffn);
