...
\begin{tcolorbox}[title={Capacity Planning: A100/H100 Quick Rules}, colback=gray!5, colframe=gray!50, breakable, width=\textwidth, fonttitle=\small]
\small
...
\begin{itemize}
\item \textbf{A100-40GB:} 7B fits with moderate $B{\times}T$ (e.g., $B{=}8, T{=}2048$ $\Rightarrow$ $\sim$14+8=\SI{22}{\gibi\byte}$); 13B fits only with conservative $B{\times}T$ (e.g., $B{=}4, T{=}4096$ $\Rightarrow$ $\sim$26+12.5=\SI{38.5}{\gibi\byte}$, tight).\\
