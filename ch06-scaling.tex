...
\begin{tikzpicture}[
  >=Stealth,
  milestone/.style={draw=none, rounded corners=4pt, align=left, minimum width=4.1cm, minimum height=0.8cm, inner sep=3pt},
  initial/.style={milestone, fill=blue!15},
  intermediate/.style={milestone, fill=green!15},
  mature/.style={milestone, fill=orange!15},
