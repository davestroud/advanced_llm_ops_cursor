...
Fig.~\ref{fig:ch06_autoscale_target_tracking} illustrates a token-aware target-tracking loop for autoscaling inference replicas under bursty demand.
...
\begin{axis}[
    ...
    legend style={at={(0.5,1.03)},anchor=south,draw=none,fill=none,font=\normalsize},
    tick align=outside,
    xlabel style={font=\normalsize},
    ylabel style={font=\normalsize},
...
% Demand (tokens/s) - thicker line with markers
\addplot+[ultra thick, blue!80!black, mark=*, mark size=2pt, mark options={fill=blue!80!black, draw=white, line width=0.5pt}] coordinates {
(0,300) (10,320) (20,350) (30,600) (40,900) (50,950) (60,700) (70,500) (80,420) (90,350) (100,320)
};
\addlegendentry{Demand $D(t)$}

% Capacity with headroom gamma=0.7 (N changes) - thicker dashed line with square markers
\addplot+[ultra thick, dashed, red!80!black, mark=square*, mark size=2pt, mark options={fill=red!80!black, draw=white, line width=0.5pt}] coordinates {
(0,430) (20,430) (30,430) (40,860) (55,860) (60,860) (70,600) (85,600) (100,430)
};
\addlegendentry{Provisioned capacity $(\gamma\,\hat{C})\cdot N(t)$}

% Horizontal line for single-replica capacity at gamma*C_hat - more visible
\addplot+[domain=0:100, samples=2, gray!70!black, dashdotted, ultra thick, line width=1.2pt] {430};
\node[gray!70!black, font=\normalsize] at (axis cs:6,470) {$\gamma\,\hat{C}$ per replica};

% Annotations - larger font, better visibility
\node[anchor=west, font=\normalsize\bfseries, text=blue!80!black] at (axis cs:31,680) {spike};
\draw[->,>=stealth,ultra thick, blue!80!black, line width=1.2pt] (axis cs:28,650) -- (axis cs:32,600);

\node[anchor=west, font=\normalsize\bfseries, text=red!80!black] at (axis cs:42,990) {$N\uparrow$ (scale out)};
\draw[->,>=stealth,ultra thick, red!80!black, line width=1.2pt] (axis cs:39,940) -- (axis cs:42,860);

\node[anchor=east, font=\normalsize\bfseries, text=red!80!black] at (axis cs:84,650) {$N\downarrow$ (scale in)};
\draw[->,>=stealth,ultra thick, red!80!black, line width=1.2pt] (axis cs:87,600) -- (axis cs:84,600);
...
Fig.~\ref{fig:ch06_autoscale_event_based} shows an event-driven autoscaling workflow that uses external triggers to pre-warm capacity ahead of traffic spikes.
...
% Demand (tokens/s) - thicker line with circular markers
\addplot+[ultra thick, blue!80!black, mark=*, mark size=2pt, mark options={fill=blue!80!black, draw=white, line width=0.5pt}] coordinates {
(0,300) (10,320) (20,350) (30,600) (40,900) (50,950) (60,700) (70,500) (80,420) (90,350) (100,320)
};
\addlegendentry{Demand $D(t)$}

% Event-based capacity: pre-warms BEFORE spike (proactive) - thicker dashed line with square markers
\addplot+[ultra thick, dashed, green!80!black, mark=square*, mark size=2pt, mark options={fill=green!80!black, draw=white, line width=0.5pt}] coordinates {
...
% Metrics-based capacity (reactive, shown for comparison) - thicker dotted line with diamond markers
\addplot+[ultra thick, dotted, red!80!black, mark=diamond*, mark size=2pt, mark options={fill=red!80!black, draw=white, line width=0.5pt}] coordinates {
(0,430) (20,430) (30,430) (40,860) (55,860) (60,860) (70,600) (85,600) (100,430)
};
\addlegendentry{Metrics-based (reactive, reference)}

% Horizontal line for single-replica capacity - more visible, moved further right
\addplot+[domain=0:100, samples=2, gray!70!black, dashdotted, ultra thick, line width=1.2pt] {430};
\node[gray!70!black, font=\normalsize] at (axis cs:12,470) {$\gamma\,\hat{C}$ per replica};

% Event trigger annotation - moved further left and up to avoid overlap
\node[anchor=south west, align=left, font=\normalsize\bfseries, text=green!80!black] at (axis cs:2,750) {\textbf{Event trigger}\\(calendar/schedule)};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:2,730) -- (axis cs:20,600);

% Pre-warm annotation - moved further right and up to avoid overlap
\node[anchor=east, align=right, font=\normalsize\bfseries, text=green!80!black] at (axis cs:28,950) {Pre-warm\\ahead of spike};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:28,930) -- (axis cs:25,860);

% Spike annotation - moved further right to avoid overlap
\node[anchor=west, font=\normalsize\bfseries, text=blue!80!black] at (axis cs:35,750) {spike};
\draw[->,>=stealth,ultra thick, blue!80!black, line width=1.2pt] (axis cs:33,720) -- (axis cs:32,600);
...
\begin{tikzpicture}[
  ...
  every node/.style={font=\small},
  box/.style={draw=none, rounded corners, align=center, minimum width=25mm, minimum height=8mm, fill=gray!5, inner sep=3pt},
  hot/.style={draw=none, rounded corners, align=center, minimum width=27mm, minimum height=8mm, fill=gray!12, inner sep=3pt},
  dist/.style={draw=none, rounded corners, align=center, minimum width=27mm, minimum height=8mm, fill=gray!7, inner sep=3pt},
  stor/.style={draw=none, rounded corners, align=center, minimum width=27mm, minimum height=8mm, fill=gray!10, inner sep=3pt},
...
\node[align=left, font=\small] (note) at ($(embcache.north)+(0,10mm)$) {reuse vectors on\\ identical chunks};
\draw[-{Latex}, line width=0.8pt] (note.south) -- (embcache.north);
...
\begin{tikzpicture}[
  node distance=8mm and 12mm,
  every node/.style={font=\small},
  region/.style={draw=none, rounded corners, minimum width=25mm, minimum height=8mm, align=center, fill=gray!5, inner sep=3pt},
  user/.style={draw=none, rounded corners, minimum width=19mm, minimum height=7mm, align=center, fill=gray!8, inner sep=3pt},
  arr/.style={-{Latex}, line width=0.8pt},
...
\begin{tikzpicture}[
  >=Stealth,
  milestone/.style={draw=none, rounded corners, align=left, minimum width=4.1cm, minimum height=0.8cm, fill=gray!5, inner sep=2pt},
...
\begin{tcolorbox}[
  title={\textbf{Checklist. Best Practices for Scaling LLM Deployments}},
  colback=gray!5,
