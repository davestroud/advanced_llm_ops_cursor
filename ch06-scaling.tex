...
\node[right=3mm of route, font=\footnotesize, text=black!70, anchor=west, below=3mm of lookuplabel] {(in-memory / GPU)};
...
\node[below=2mm of sh2, right=3mm, font=\footnotesize\bfseries, text=green!70!black] {hit};
