...
% Event trigger annotation - improved styling
\node[
    anchor=south west,
    align=left,
    font=\footnotesize,
    ...
    inner sep=3pt,
    rounded corners=3pt
] at (axis cs:3,780) {\textbf{Event trigger}\\(calendar/schedule)};
\draw[
    ->,
    >=stealth,
    color=green!70!black,
    line width=1pt,
    shorten >=2pt
] (axis cs:3,760) -- (axis cs:20,600);

% Pre-warm annotation - improved styling
\node[
    anchor=east,
    align=right,
    font=\footnotesize,
    ...
    inner sep=3pt,
    rounded corners=3pt
] at (axis cs:27,980) {\textbf{Pre-warm}\\ahead of spike};
\draw[
    ->,
    >=stealth,
    color=green!70!black,
