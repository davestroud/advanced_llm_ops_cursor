...
% Event trigger annotation - moved further left and up to avoid overlap, less bold
\node[anchor=south west, align=left, font=\normalsize, text=green!80!black] at (axis cs:2,750) {Event trigger\\(calendar/schedule)};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:2,730) -- (axis cs:20,600);

% Pre-warm annotation - moved further right and up to avoid overlap, less bold
\node[anchor=east, align=right, font=\normalsize, text=green!80!black] at (axis cs:28,950) {Pre-warm\\ahead of spike};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:28,930) -- (axis cs:25,860);

% Spike annotation - moved further right to avoid overlap, less bold
\node[anchor=west, font=\normalsize, text=blue!80!black] at (axis cs:35,750) {spike};
