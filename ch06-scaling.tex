...
\node[box, fill=gray!20, below=8mm of v1] (v2) {\textbf{A100-80GB}\\\small GPU Node};
\node[box, fill=gray!28, below=8mm of v2] (v3) {\textbf{H100-80GB}\\\small GPU Node};
...
\node[box, fill=gray!18, right=8mm of h1] (h2) {\small GPU Node};
\node[box, fill=gray!24, right=8mm of h2] (h3) {\small GPU Node};
...
\node[box, fill=gray!12, right=8mm of hy1] (hy2) {\small\textbf{A100}\\\small Node};
\node[box, fill=gray!8, right=8mm of hy2] (hy3) {\small\textbf{CPU}\\\small Pool};
