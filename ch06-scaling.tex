...
% Horizontal line for single-replica capacity - more visible
\addplot+[domain=0:100, samples=2, gray!70!black, dashdotted, ultra thick, line width=1.2pt] {430};
\node[gray!70!black, font=\normalsize] at (axis cs:6,470) {$\gamma\,\hat{C}$ per replica};

% Event trigger annotation - larger font, better visibility
\node[anchor=south west, align=left, font=\normalsize\bfseries, text=green!80!black] at (axis cs:18,640) {\textbf{Event trigger}\\(calendar/schedule)};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:18,620) -- (axis cs:22,600);

% Pre-warm annotation - larger font, better visibility
\node[anchor=east, align=right, font=\normalsize\bfseries, text=green!80!black] at (axis cs:23,820) {Pre-warm\\ahead of spike};
\draw[->,>=stealth,ultra thick, green!80!black, line width=1.2pt] (axis cs:23,800) -- (axis cs:25,860);

% Spike annotation - larger font, better visibility
\node[anchor=west, font=\normalsize\bfseries, text=blue!80!black] at (axis cs:31,680) {spike};
\draw[->,>=stealth,ultra thick, blue!80!black, line width=1.2pt] (axis cs:28,650) -- (axis cs:32,600);
