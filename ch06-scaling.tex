...
% "first lookup" label positioned above the (in-memory / GPU) label
\node[above=2mm of hotlabel, font=\footnotesize, text=black!70] {first lookup};
...
% "hit" label positioned to the right of the arrow line
\node[right=3mm of sh2, font=\footnotesize\bfseries, text=green!70!black] {hit};
