...
\begin{tikzpicture}[
  ...
  arrow/.style={->, >=Stealth, line width=0.6pt, draw=black!70},
  labelbox/.style={
    rectangle,
    draw=none,
    fill=none,
...
\node[box, fill=gray!12] (v1) at (0,3) {\textbf{A100-40GB}\\\small GPU Node};
\node[box, fill=gray!20, below=10mm of v1] (v2) {\textbf{A100-80GB}\\\small GPU Node};
\node[box, fill=gray!28, below=10mm of v2] (v3) {\textbf{H100-80GB}\\\small GPU Node};

\node[labelbox, right=12mm of v2] (vlabel) {
  \textbf{Vertical Scaling}\\[2pt]
...
\node[box, fill=gray!12] (h1) at (7,3) {\small GPU Node};
\node[box, fill=gray!18, right=10mm of h1] (h2) {\small GPU Node};
\node[box, fill=gray!24, right=10mm of h2] (h3) {\small GPU Node};

\node[labelbox, below=8mm of h2] (hlabel) {
  \textbf{Horizontal Scaling}\\[2pt]
...
\node[box, fill=gray!18] (hy1) at (7,0) {\small\textbf{H100}\\\small Node};
\node[box, fill=gray!12, right=10mm of hy1] (hy2) {\small\textbf{A100}\\\small Node};
\node[box, fill=gray!8, right=10mm of hy2] (hy3) {\small\textbf{CPU}\\\small Pool};

\node[labelbox, below=8mm of hy2] (hylabel) {
  \textbf{Hybrid Scaling}\\[2pt]
...
\begin{tikzpicture}[
  ...
  box/.style={draw=black!70, rounded corners, line width=0.8pt, align=center, minimum width=29mm, minimum height=9mm, fill=gray!5, inner sep=4pt},
  hot/.style={draw=black!70, rounded corners, line width=0.8pt, align=center, minimum width=32mm, minimum height=9mm, fill=gray!12, inner sep=4pt},
  dist/.style={draw=black!70, rounded corners, line width=0.8pt, align=center, minimum width=32mm, minimum height=9mm, fill=gray!7, inner sep=4pt},
  stor/.style={draw=black!70, rounded corners, line width=0.8pt, align=center, minimum width=32mm, minimum height=9mm, fill=gray!10, inner sep=4pt},
...
\begin{tikzpicture}[
  node distance=10mm and 15mm,
  every node/.style={font=\small},
  region/.style={draw=black!70, rounded corners, line width=0.8pt, minimum width=29mm, minimum height=10mm, align=center, fill=gray!5, inner sep=4pt},
  user/.style={draw=black!70, rounded corners, line width=0.8pt, minimum width=22mm, minimum height=8mm, align=center, fill=gray!8, inner sep=4pt},
  arr/.style={-{Latex}, line width=0.8pt},
  fail/.style={-{Latex}, line width=0.8pt, dashed, color=black!50}
]
% Schematic world frame (purely illustrative)
\node[draw=black!70, rounded corners, line width=0.8pt, minimum width=115mm, minimum height=52mm, fill=gray!2] (frame) {};
