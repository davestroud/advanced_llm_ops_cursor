...
\begin{tikzpicture}[
  >=Stealth,
  milestone/.style={draw=none, rounded corners=4pt, align=left, inner sep=3pt},
  initial/.style={milestone, fill=blue!15, minimum width=4.1cm, minimum height=0.8cm},
  intermediate/.style={milestone, fill=green!15, minimum width=4.3cm, minimum height=1.0cm},
  mature/.style={milestone, fill=orange!15, minimum width=4.5cm, minimum height=1.0cm},
...
\node[mature, anchor=north east] (m2) at (15.2,-1.8) {%
\textbf{Mature Stage}\\
