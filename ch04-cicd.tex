...
% Baseline/bundle box under pre/post/night - reduced fill opacity to prevent text obscuring
\node[draw=cyan!60, dashed, line width=1pt, fill=cyan!3, rounded corners=6pt, fit=(pre)(post)(night), 
