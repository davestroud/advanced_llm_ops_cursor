...
\begin{tikzpicture}[
  ...
  partlabel/.style={font=\footnotesize\bfseries, color=black!65, anchor=west}
]
...
\node[partlabel] at ([yshift=9mm]fund.north) {\textbf{Part I: Foundations}};
\node[partlabel] at ([yshift=9mm]cicd.north) {\textbf{Part II: Delivery Operations}};
\node[partlabel] at ([yshift=9mm]perf.north) {\textbf{Part III: Optimization}};
...
\node[partlabel] at ([yshift=9mm]test.north) {\textbf{Part IV: Governance}};
