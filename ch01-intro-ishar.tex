...
\begin{tikzpicture}[
  ...
  % Component styles (grayscale-safe with line styles)
  user/.style={ellipse, draw=black!70, fill=gray!10, line width=0.8pt, minimum width=18mm, minimum height=9mm, align=center, font=\footnotesize\bfseries},
  orchestrator/.style={rectangle, draw=black!70, fill=gray!20, line width=0.8pt, rounded corners=4pt, minimum width=32mm, minimum height=11mm, align=center, font=\footnotesize\bfseries},
  retriever/.style={rectangle, draw=black!60, fill=gray!10, line width=0.8pt, rounded corners=4pt, minimum width=25mm, minimum height=9mm, align=center, font=\footnotesize},
  knowledge/.style={rectangle, draw=black!60, fill=gray!10, line width=0.8pt, rounded corners=4pt, minimum width=24mm, minimum height=10mm, align=center, font=\footnotesize},
  llm/.style={rectangle, draw=black!70, fill=gray!15, line width=0.8pt, rounded corners=4pt, minimum width=23mm, minimum height=11mm, align=center, font=\footnotesize\bfseries},
  tool/.style={rectangle, draw=black!60, fill=gray!10, line width=0.8pt, rounded corners=4pt, minimum width=22mm, minimum height=9mm, align=center, font=\footnotesize},
  response/.style={ellipse, draw=black!70, fill=gray!10, line width=0.8pt, minimum width=18mm, minimum height=9mm, align=center, font=\footnotesize\bfseries},
  failure/.style={circle, draw=black!70, fill=gray!15, line width=0.8pt, minimum size=5mm},
  % Arrow styles (grayscale-safe with line styles)
  mainflow/.style={-{Latex}, line width=0.8pt, color=black!70},
  fallback/.style={-{Latex}, dashed, line width=0.8pt, color=black!50},
  toolflow/.style={-{Latex}, line width=0.8pt, color=black!60},
  retrieval/.style={-{Latex}, line width=0.8pt, color=black!60},
  queryflow/.style={-{Latex}, line width=0.8pt, color=black!70},
  label/.style={font=\footnotesize, color=black!60}
]

% User and Response (top level)
\node[user] (user) {User};
\node[response, right=42mm of user] (response) {Response};

% Orchestrator (center)
\node[orchestrator, below=16mm of user] (orchestrator) {\begin{tabular}{c}Orchestrator\\\footnotesize LLM Application\end{tabular}};

% Retriever and Knowledge Base (left side)
\node[retriever, below left=14mm and 18mm of orchestrator] (retriever) {\begin{tabular}{c}Retriever\\\footnotesize (Vector DB)\end{tabular}};
\node[knowledge, below=12mm of retriever] (knowledge) {\begin{tabular}{c}Knowledge Base\\\footnotesize (Documents)\end{tabular}};

% LLM Model (right side)
\node[llm, below right=14mm and 18mm of orchestrator] (llm) {LLM Model};

% External Tool (below LLM)
\node[tool, below=12mm of llm] (tool) {\begin{tabular}{c}External Tool\\\footnotesize / API\end{tabular}};

% Failure indicator
\node[failure, left=7mm of retriever] (failure) {\textbf{×}};
...
\draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (retriever) -- (failure);
\node[font=\footnotesize, color=black!60, left=2mm of failure] {Failure};
...
\draw[fallback] (orchestrator) to[out=0,in=180, looseness=1.0] node[label, above, pos=0.5, font=\footnotesize] {Fallback: skip retrieval} (llm);
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    >=Stealth,
    % Box styles (grayscale-safe with line styles)
    surface/.style={rectangle, draw=black!70, fill=gray!10, line width=0.8pt, rounded corners=4pt, minimum width=25mm, minimum height=12mm, align=center, font=\small},
    threat/.style={rectangle, draw=black!70, fill=gray!12, line width=0.8pt, rounded corners=4pt, minimum width=25mm, minimum height=10mm, align=center, font=\small},
    control/.style={rectangle, draw=black!70, fill=gray!10, line width=0.8pt, rounded corners=4pt, minimum width=25mm, minimum height=12mm, align=center, font=\small},
    crosscut/.style={rectangle, draw=black!70, fill=gray!8, line width=0.8pt, rounded corners=4pt, minimum width=140mm, minimum height=8mm, align=center, font=\footnotesize},
    arrow/.style={-{Latex}, line width=0.8pt, color=black!70}
  ]
  ...
  \draw[-{Latex}, line width=0.8pt, color=black!60] (input.east) -- (prompt.west);
  \draw[-{Latex}, line width=0.8pt, color=black!60] (prompt.east) -- (retrieval.west);
  \draw[-{Latex}, line width=0.8pt, color=black!60] (retrieval.east) -- (tools.west);
  \draw[-{Latex}, line width=0.8pt, color=black!60] (tools.east) -- (output.west);
  ...
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (input.south) -- (inj.north);
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (prompt.south) -- (inj.north);
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (prompt.south) -- (bypass.north);
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (retrieval.south) -- (exfil.north);
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (tools.south) -- (misuse.north);
  \draw[-{Latex}, dashed, line width=0.8pt, color=black!50] (output.south) -- (leak.north);
  ...
  \draw[-{Latex}, line width=0.8pt, color=black!70] (inj.south) -- (sanitize.north);
  \draw[-{Latex}, line width=0.8pt, color=black!70] (bypass.south) -- (hierarchy.north);
  \draw[-{Latex}, line width=0.8pt, color=black!70] (exfil.south) -- (governance.north);
  \draw[-{Latex}, line width=0.8pt, color=black!70] (misuse.south) -- (toolsec.north);
  \draw[-{Latex}, line width=0.8pt, color=black!70] (leak.south) -- (outctrl.north);

  % Cross-cutting connections (dotted for distinction)
  \draw[-{Latex}, dotted, line width=0.8pt, color=black!50] ($(tracing.north west)!0.1!(tracing.north east)$) to[out=90,in=-90] (inj);
  \draw[-{Latex}, dotted, line width=0.8pt, color=black!50] ($(tracing.north west)!0.3!(tracing.north east)$) to[out=90,in=-90] (bypass);
  \draw[-{Latex}, dotted, line width=0.8pt, color=black!50] ($(tracing.north west)!0.5!(tracing.north east)$) to[out=90,in=-90] (exfil);
  \draw[-{Latex}, dotted, line width=0.8pt, color=black!50] ($(tracing.north west)!0.7!(tracing.north east)$) to[out=90,in=-90] (misuse);
  \draw[-{Latex}, dotted, line width=0.8pt, color=black!50] ($(tracing.north east)$) to[out=90,in=-90] (leak);
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    % Box styles - simplified
    constraint/.style={rectangle, draw=red!70!black, fill=red!10, thick, rounded corners=4pt, minimum width=2.5cm, minimum height=1cm, align=center, font=\footnotesize\bfseries},
    slo/.style={rectangle, draw=blue!70!black, fill=blue!10, thick, rounded corners=4pt, minimum width=2.2cm, minimum height=0.9cm, align=center, font=\footnotesize\bfseries},
    lever/.style={rectangle, draw=green!70!black, fill=green!10, thick, rounded corners=4pt, minimum width=2.2cm, minimum height=0.8cm, align=center, font=\footnotesize\bfseries},
  ...
  \draw[arrow, color=red!70!black] (param.east) -- (ttft.west);
  \draw[arrow, color=red!70!black] (param.east) -- (parallel.west);
  
  \draw[arrow, color=orange!70!black] (context.east) -- (ttft.west);
  \draw[arrow, color=orange!70!black] (context.east) -- (tput.west);
  
  \draw[arrow, color=purple!70!black] (kv.east) -- (tput.west);
  
  \draw[arrow, color=blue!70!black] (ttft.east) -- (parallel.west);
  \draw[arrow, color=blue!70!black] (tput.east) -- (quant.west);
  \draw[arrow, color=blue!70!black] (tput.east) -- (batch.west);
  \draw[arrow, color=blue!70!black] (cost.east) -- (quant.west);
  
  \draw[arrow, color=green!70!black] (parallel.west) -- (cost.east);
  \draw[arrow, color=green!70!black] (quant.west) -- (cost.east);
  \draw[arrow, color=green!70!black] (batch.west) -- (tput.east);

  % Column labels (simpler, no braces)
  \node[font=\small\bfseries, color=red!70!black, above=0.4cm of param] {Constraints};
  \node[font=\small\bfseries, color=blue!70!black, above=0.4cm of ttft] {SLOs};
  \node[font=\small\bfseries, color=green!70!black, above=0.4cm of parallel] {Levers};
...
\begin{tikzpicture}[
  ...
  seg/.style    ={rounded corners=3pt, minimum width=38mm, minimum height=16mm,
                  inner sep=5pt, align=center, line width=0.6pt, font=\small},
  arrow/.style  ={-{Stealth[length=2.2mm,width=1.8mm]}, line width=0.5pt},
  note/.style   ={font=\small, align=center, text=black!70},
  e2e/.style    ={draw=black!40, rounded corners=3pt, fill=black!3, 
                  inner sep=4pt, align=left, font=\small}
]

% Band container - larger to accommodate stacked boxes with proper spacing
\node[band, minimum width=0.95\linewidth, minimum height=70mm] (bandbox) {};

% Top row: 4 boxes (Ingestion, Retrieval, Agents, Serving)
\node[seg,cIngest] (ing) at ([xshift=-60mm,yshift=12mm]bandbox.center) {Ingestion\\\scriptsize (feeds, ETL)};
\node[seg,cRAG, right=of ing] (rag) {Retrieval\\\scriptsize (RAG)};
\node[seg,cAgent, right=of rag] (agent) {Agents\\\scriptsize (orchestration)};
\node[seg,cServe, right=of agent] (serve) {Serving\\\scriptsize (GPU/TPU)};

% Bottom row: 3 boxes (Observability, Testing, Ethics) - centered, more spacing from top
\node[seg,cObs] (obs) at ([xshift=-40mm,yshift=-20mm]bandbox.center) {Observability\\\scriptsize (traces, SLOs)};
\node[seg,cTest, right=of obs] (test) {Testing\\\scriptsize (eval/robust)};
\node[seg,cEth, right=of test] (eth) {Ethics\\\scriptsize (governance)};
...
\begin{tikzpicture}[
  font=\small,
  % Color styles for different components
  source/.style={ellipse, fill=blue!20, draw=blue!60!black, line width=0.7pt, 
                 minimum width=20mm, minimum height=10mm, align=center, inner sep=3pt},
  ingest/.style={rectangle, fill=cyan!20, draw=cyan!60!black, rounded corners=4pt,
                 line width=0.7pt, minimum width=22mm, minimum height=11mm, align=center, inner sep=3pt},
  vector/.style={cylinder, fill=teal!20, draw=teal!60!black, line width=0.7pt,
                 shape aspect=0.3, minimum width=22mm, minimum height=15mm, align=center, inner sep=3pt},
  rag/.style={rectangle, fill=purple!20, draw=purple!60!black, rounded corners=4pt,
              line width=0.7pt, minimum width=26mm, minimum height=13mm, align=center, inner sep=3pt},
  agent/.style={rectangle, fill=green!20, draw=green!60!black, rounded corners=4pt,
                line width=0.7pt, minimum width=20mm, minimum height=10mm, align=center, inner sep=2pt},
  orchestrator/.style={rectangle, fill=orange!20, draw=orange!60!black, rounded corners=4pt,
                       line width=0.8pt, minimum width=28mm, minimum height=12mm, align=center, inner sep=3pt, font=\small\bfseries},
  gpu/.style={rectangle, fill=red!20, draw=red!60!black, rounded corners=4pt,
              line width=0.7pt, minimum width=24mm, minimum height=13mm, align=center, inner sep=3pt},
  response/.style={ellipse, fill=gray!20, draw=gray!60!black, line width=0.7pt,
                  minimum width=22mm, minimum height=10mm, align=center, inner sep=3pt},
  obs/.style={rectangle, fill=yellow!8, draw=black!25, rounded corners=3pt, dashed,
              line width=0.6pt, inner sep=2pt, font=\footnotesize},
  arrow/.style={-{Stealth[length=2.2mm,width=1.8mm]}, line width=0.7pt, color=black!75},
  arrowthin/.style={-{Stealth[length=1.8mm,width=1.4mm]}, line width=0.5pt, color=black!60}
]

% Use explicit coordinates - compact layout centered around origin
% ========== LEFT COLUMN: Data Sources & Ingestion ==========
% Data sources (stacked vertically, left side)
\node[source] (news) at (-25mm, 12mm) {News wires\\\& reports};
\node[source] (ngo) at (-25mm, 0mm) {NGO\\bulletins};
\node[source] (social) at (-25mm, -12mm) {Social media\\(vetted)};

% Ingestion agents (middle-left)
\node[ingest] (ingest1) at (-8mm, 12mm) {Ingestion\\Agent 1};
\node[ingest] (ingest2) at (-8mm, 0mm) {Ingestion\\Agent 2};
\node[ingest] (ingest3) at (-8mm, -12mm) {Ingestion\\Agent 3};

% Vector database (center-left, below)
\node[vector] (vectordb) at (-8mm, -26mm) {Vector\\Database};

% ========== CENTER COLUMN: Query, RAG & Orchestration ==========
% Query input (top center)
\node[source] (query) at (12mm, 16mm) {Journalist\\Query};

% RAG retrieval (center)
\node[rag] (retrieval) at (12mm, 0mm) {RAG\\Retrieval};

% Multi-agent orchestration (below RAG)
\node[orchestrator] (orchestrator) at (12mm, -16mm) {Orchestrator};

% Agents (below orchestrator, compact row)
\node[agent] (summarizer) at (4mm, -28mm) {Summarizer};
\node[agent] (factchecker) at (12mm, -28mm) {Fact-Checker};
\node[agent] (refiner) at (20mm, -28mm) {Refiner};

% ========== RIGHT COLUMN: GPU & Response ==========
% GPU inference cluster
\node[gpu] (gpu1) at (38mm, -8mm) {GPU\\Node 1};
\node[gpu] (gpu2) at (38mm, -24mm) {GPU\\Node 2};

% Response (right of GPU)
\node[response] (response) at (55mm, -16mm) {Response\\+ Citations};

% ========== ARROWS: Data Flow ==========
% Sources to ingestion (horizontal)
\draw[arrowthin] (news.east) -- (ingest1.west);
\draw[arrowthin] (ngo.east) -- (ingest2.west);
\draw[arrowthin] (social.east) -- (ingest3.west);

% Ingestion to vector database (downward)
\draw[arrowthin] (ingest1.south) -- (vectordb.north);
\draw[arrowthin] (ingest2.south) -- (vectordb.north);
\draw[arrowthin] (ingest3.south) -- (vectordb.north);

% Query to RAG (downward)
\draw[arrow] (query.south) -- (retrieval.north);

% RAG to vector database (retrieval - horizontal)
\draw[arrowthin, dashed] (retrieval.west) -- (vectordb.east);

% RAG to orchestrator (downward)
\draw[arrow] (retrieval.south) -- (orchestrator.north);

% Orchestrator to agents (downward)
\draw[arrowthin] (orchestrator.south west) -- (summarizer.north);
\draw[arrowthin] (orchestrator.south) -- (factchecker.north);
\draw[arrowthin] (orchestrator.south east) -- (refiner.north);

% Agents to GPU (horizontal)
\draw[arrow] (summarizer.east) -- (gpu1.west);
\draw[arrow] (factchecker.east) -- (gpu2.west);
\draw[arrow] (refiner.east) -- (gpu1.west);

% GPU to response (horizontal)
\draw[arrow] (gpu1.east) -- (response.west);
\draw[arrowthin] (gpu2.east) -- (response.west);

% ========== OBSERVABILITY LAYER ==========
% Top observability band - positioned after all nodes are defined, tighter spacing
\node[obs, fit=(news) (social) (ingest1) (ingest3) (vectordb) (query) (retrieval) (orchestrator) (summarizer) (refiner) (gpu1) (gpu2) (response),
      inner xsep=2mm, inner ysep=1.5mm, yshift=18mm,
      label={[anchor=center, font=\small\bfseries, text=black!80]center:Observability \& Telemetry}] (obstop) {};

% Bottom observability band - tighter spacing
\node[obs, fit=(news) (social) (ingest1) (ingest3) (vectordb) (query) (retrieval) (orchestrator) (summarizer) (refiner) (gpu1) (gpu2) (response),
      inner xsep=2mm, inner ysep=1.5mm, yshift=-26mm,
      label={[anchor=center, font=\small\bfseries, text=black!80]center:Traces, Metrics, Logs}] (obsbot) {};

% Observability connections (subtle dotted lines)
\draw[arrowthin, dotted, color=black!35] ([xshift=-2mm]obstop.south) -- ([xshift=-2mm]vectordb.north);
\draw[arrowthin, dotted, color=black!35] (obstop.south) -- (retrieval.north);
\draw[arrowthin, dotted, color=black!35] ([xshift=2mm]obstop.south) -- ([xshift=2mm]orchestrator.north);
\draw[arrowthin, dotted, color=black!35] ([xshift=-2mm]obsbot.north) -- ([xshift=-2mm]orchestrator.south);
\draw[arrowthin, dotted, color=black!35] (obsbot.north) -- (gpu1.south);
...
\begin{tikzpicture}[
  ...
  bubble/.style ={circle, minimum size=18mm, inner sep=3pt, line width=0.6pt, align=center, font=\small},
  arrowthin/.style={-{Stealth[length=2mm,width=1.6mm]}, line width=0.5pt},
  note/.style   ={font=\small, align=left, text=black!70},
  funnel/.style ={draw=black!30, fill=black!4, rounded corners=3pt, inner sep=4pt,
                  minimum width=26mm, minimum height=10mm, align=center, font=\small},
  journalist/.style={draw=black!60, rounded corners=4pt, fill=black!1, 
                     minimum height=12mm, inner sep=4pt, align=center, font=\small}
]

% Hub container positioned first
\node[hub, minimum width=90mm, minimum height=60mm] (group) {};
\node[black!50, font=\small] at ([yshift=-8pt]group.north) {Curated external evidence (ingested and vetted)};

% Position bubbles relative to hub center in a 2x2 grid
\node[bubble,cNews] (news) at ([xshift=-22mm,yshift=10mm]group.center) {News wires\\\& reports};
\node[bubble,cNGO] (ngo) at ([xshift=22mm,yshift=10mm]group.center) {NGO bulletins};
\node[bubble,cSocial] (social) at ([xshift=-22mm,yshift=-10mm]group.center) {Social media\\(vetted)};
\node[bubble,cHealth] (health) at ([xshift=22mm,yshift=-10mm]group.center) {Public health\\\& infrastructure};
...
\node[funnel] (funnel) at ([xshift=45mm]group.east) {RAG retrieval};
