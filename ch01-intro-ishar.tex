...
\begin{tikzpicture}[
  ...
  source/.style={ellipse, fill=blue!15, draw=blue!50!black, line width=0.6pt, 
                 minimum width=20mm, minimum height=10mm, align=center, inner sep=3pt},
  ingest/.style={rectangle, fill=cyan!15, draw=cyan!50!black, rounded corners=3pt,
                 line width=0.6pt, minimum width=24mm, minimum height=12mm, align=center, inner sep=4pt},
  vector/.style={cylinder, fill=teal!15, draw=teal!50!black, line width=0.6pt,
                 shape aspect=0.3, minimum width=20mm, minimum height=16mm, align=center, inner sep=3pt},
  rag/.style={rectangle, fill=purple!15, draw=purple!50!black, rounded corners=3pt,
              line width=0.6pt, minimum width=28mm, minimum height=14mm, align=center, inner sep=4pt},
  agent/.style={rectangle, fill=green!15, draw=green!50!black, rounded corners=3pt,
                line width=0.6pt, minimum width=22mm, minimum height=10mm, align=center, inner sep=3pt},
  orchestrator/.style={rectangle, fill=orange!15, draw=orange!50!black, rounded corners=3pt,
                       line width=0.7pt, minimum width=30mm, minimum height=12mm, align=center, inner sep=4pt, font=\small\bfseries},
  gpu/.style={rectangle, fill=red!15, draw=red!50!black, rounded corners=3pt,
              line width=0.6pt, minimum width=26mm, minimum height=14mm, align=center, inner sep=4pt},
  response/.style={ellipse, fill=gray!15, draw=gray!50!black, line width=0.6pt,
                  minimum width=22mm, minimum height=10mm, align=center, inner sep=3pt},
  obs/.style={rectangle, fill=yellow!10, draw=black!30, rounded corners=2pt, dashed,
              line width=0.5pt, minimum width=140mm, minimum height=8mm, align=center, inner sep=3pt, font=\footnotesize},
  arrow/.style={-{Stealth[length=2.5mm,width=2mm]}, line width=0.7pt, color=black!70},
  arrowthin/.style={-{Stealth[length=2mm,width=1.5mm]}, line width=0.5pt, color=black!60}
]
...
% Vector database
\node[vector, right=of ingest2, yshift=8mm] (vectordb) {Vector\\Database};

% ========== MIDDLE LANE: RAG & Multi-Agent ==========
% Query input
\node[source, right=of vectordb, yshift=15mm] (query) {Journalist\\Query};

% RAG retrieval
\node[rag, below=of query] (retrieval) {RAG\\Retrieval};

% Multi-agent orchestration
\node[orchestrator, below=of retrieval] (orchestrator) {Orchestrator};

% Agents
\node[agent, below left=of orchestrator, xshift=-5mm] (summarizer) {Summarizer};
\node[agent, below=of orchestrator] (factchecker) {Fact-Checker};
\node[agent, below right=of orchestrator, xshift=5mm] (refiner) {Refiner};
...
% Response
\node[response, right=of gpu1, yshift=-8mm] (response) {Response\\+ Citations};
...
\node[obs, fit=(news) (vectordb) (query) (retrieval) (orchestrator) (gpu1) (response),
      yshift=22mm, label={[anchor=center, font=\small\bfseries]center:Observability \& Telemetry}] (obstop) {};

% Bottom observability band  
\node[obs, fit=(news) (vectordb) (query) (retrieval) (orchestrator) (gpu1) (response),
      yshift=-22mm, label={[anchor=center, font=\small\bfseries]center:Traces, Metrics, Logs}] (obsbot) {};

% Observability connections (subtle dotted lines to show cross-cutting)
\draw[arrowthin, dotted, color=black!30] ([xshift=-2mm]obstop.south) -- ([xshift=-2mm]vectordb.north);
\draw[arrowthin, dotted, color=black!30] (obstop.south) -- (retrieval.north);
\draw[arrowthin, dotted, color=black!30] ([xshift=2mm]obstop.south) -- ([xshift=2mm]orchestrator.north);
\draw[arrowthin, dotted, color=black!30] ([xshift=-2mm]obsbot.north) -- ([xshift=-2mm]orchestrator.south);
\draw[arrowthin, dotted, color=black!30] (obsbot.north) -- (gpu1.south);
