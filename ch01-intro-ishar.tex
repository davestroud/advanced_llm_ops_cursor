...
\begin{tikzpicture}[
  ...
  scale=0.85,
  transform shape,
  % Color styles for different components - compact sizes
  source/.style={ellipse, fill=blue!20, draw=blue!60!black, line width=0.7pt, 
                 minimum width=16mm, minimum height=8mm, align=center, inner sep=2pt},
  ingest/.style={rectangle, fill=cyan!20, draw=cyan!60!black, rounded corners=4pt,
                 line width=0.7pt, minimum width=18mm, minimum height=9mm, align=center, inner sep=2pt},
  vector/.style={cylinder, fill=teal!20, draw=teal!60!black, line width=0.7pt,
                 shape aspect=0.3, minimum width=18mm, minimum height=12mm, align=center, inner sep=2pt},
  rag/.style={rectangle, fill=purple!20, draw=purple!60!black, rounded corners=4pt,
              line width=0.7pt, minimum width=22mm, minimum height=11mm, align=center, inner sep=2pt},
  agent/.style={rectangle, fill=green!20, draw=green!60!black, rounded corners=4pt,
                line width=0.7pt, minimum width=18mm, minimum height=8mm, align=center, inner sep=2pt},
  orchestrator/.style={rectangle, fill=orange!20, draw=orange!60!black, rounded corners=4pt,
                       line width=0.8pt, minimum width=24mm, minimum height=10mm, align=center, inner sep=2pt, font=\small\bfseries},
  gpu/.style={rectangle, fill=red!20, draw=red!60!black, rounded corners=4pt,
              line width=0.7pt, minimum width=20mm, minimum height=11mm, align=center, inner sep=2pt},
  ...
  arrow/.style={-{Stealth[length=2mm,width=1.6mm]}, line width=0.7pt, color=black!75},
  arrowthin/.style={-{Stealth[length=1.6mm,width=1.2mm]}, line width=0.5pt, color=black!60}
]
...
% Query input
\node[source, right=of vectordb, yshift=7mm] (query) {Journalist\\Query};

% RAG retrieval
\node[rag, right=of vectordb] (retrieval) {RAG\\Retrieval};

% Multi-agent orchestration
\node[orchestrator, right=of vectordb, yshift=-7mm] (orchestrator) {Orchestrator};

% Agents
\node[agent, below left=of orchestrator, xshift=-2mm] (summarizer) {Summarizer};
\node[agent, below=of orchestrator] (factchecker) {Fact-Checker};
\node[agent, below right=of orchestrator, xshift=2mm] (refiner) {Refiner};
