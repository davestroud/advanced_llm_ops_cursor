...
\node[vector, below=24mm of ingest3, xshift=-4mm] (vectordb) {Vector\\Database};
...
\node[response, right=24mm of gpu1] (response) {Response\\+ Citations};
...
\node[rectangle, fill=yellow!8, draw=black!30, dashed, line width=0.8pt, rounded corners=4pt,
      minimum width=160mm, minimum height=10mm,
