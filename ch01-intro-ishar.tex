...
\node[font=\footnotesize, color=black!60, left=0.2cm of failure] {Failure};
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[
    >=Stealth,
    % Box styles - simplified and clearer
    surface/.style={rectangle, draw=blue!70!black, fill=blue!10, thick, rounded corners=4pt, minimum width=2.5cm, minimum height=1.2cm, align=center, font=\small},
    threat/.style={rectangle, draw=red!70!black, fill=red!12, thick, rounded corners=4pt, minimum width=2.5cm, minimum height=1cm, align=center, font=\small},
    control/.style={rectangle, draw=green!70!black, fill=green!10, thick, rounded corners=4pt, minimum width=2.5cm, minimum height=1.2cm, align=center, font=\small},
    crosscut/.style={rectangle, draw=purple!70!black, fill=purple!8, thick, rounded corners=4pt, minimum width=14cm, minimum height=0.8cm, align=center, font=\footnotesize},
  ...
  \draw[->, thick, color=blue!60!black] (input.east) -- (prompt.west);
  \draw[->, thick, color=blue!60!black] (prompt.east) -- (retrieval.west);
  \draw[->, thick, color=blue!60!black] (retrieval.east) -- (tools.west);
  \draw[->, thick, color=blue!60!black] (tools.east) -- (output.west);
  ...
  \draw[arrow, color=red!70!black] (input.south) -- (inj.north);
  \draw[arrow, color=red!70!black] (prompt.south) -- (inj.north);
  \draw[arrow, color=red!70!black] (prompt.south) -- (bypass.north);
  \draw[arrow, color=red!70!black] (retrieval.south) -- (exfil.north);
  \draw[arrow, color=red!70!black] (tools.south) -- (misuse.north);
  \draw[arrow, color=red!70!black] (output.south) -- (leak.north);
  ...
  \draw[arrow, color=green!70!black] (inj.south) -- (sanitize.north);
  \draw[arrow, color=green!70!black] (bypass.south) -- (hierarchy.north);
  \draw[arrow, color=green!70!black] (exfil.south) -- (governance.north);
  \draw[arrow, color=green!70!black] (misuse.south) -- (toolsec.north);
  \draw[arrow, color=green!70!black] (leak.south) -- (outctrl.north);

  % Cross-cutting connections (dashed)
  \draw[->, dashed, thick, color=purple!70!black] ($(tracing.north west)!0.1!(tracing.north east)$) to[out=90,in=-90] (inj);
  \draw[->, dashed, thick, color=purple!70!black] ($(tracing.north west)!0.3!(tracing.north east)$) to[out=90,in=-90] (bypass);
  \draw[->, dashed, thick, color=purple!70!black] ($(tracing.north west)!0.5!(tracing.north east)$) to[out=90,in=-90] (exfil);
  \draw[->, dashed, thick, color=purple!70!black] ($(tracing.north west)!0.7!(tracing.north east)$) to[out=90,in=-90] (misuse);
  \draw[->, dashed, thick, color=purple!70!black] ($(tracing.north east)$) to[out=90,in=-90] (leak);

  % Layer labels
  \node[font=\normalsize\bfseries, color=blue!70!black, above=0.3cm of input, anchor=west, xshift=-0.5cm] {Threat surfaces};
  \node[font=\normalsize\bfseries, color=red!70!black, above=0.2cm of inj, anchor=west, xshift=-0.5cm] {Threats (what can go wrong)};
  \node[font=\normalsize\bfseries, color=green!70!black, below=0.2cm of sanitize, anchor=west, xshift=-0.5cm] {Controls (what you implement)};
