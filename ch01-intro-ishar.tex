...
\begin{tikzpicture}[
  ...
  user/.style={ellipse, draw=none, fill=gray!10, minimum width=18mm, minimum height=9mm, align=center, font=\small\bfseries},
  orchestrator/.style={rectangle, draw=none, fill=gray!20, rounded corners=4pt, minimum width=32mm, minimum height=11mm, align=center, font=\small\bfseries},
  retriever/.style={rectangle, draw=none, fill=gray!10, rounded corners=4pt, minimum width=25mm, minimum height=9mm, align=center, font=\small},
  knowledge/.style={rectangle, draw=none, fill=gray!10, rounded corners=4pt, minimum width=24mm, minimum height=10mm, align=center, font=\small},
  llm/.style={rectangle, draw=none, fill=gray!15, rounded corners=4pt, minimum width=24mm, minimum height=11mm, align=center, font=\small\bfseries},
  tool/.style={rectangle, draw=none, fill=gray!10, rounded corners=4pt, minimum width=22mm, minimum height=9mm, align=center, font=\small},
  response/.style={ellipse, draw=none, fill=gray!10, minimum width=18mm, minimum height=9mm, align=center, font=\small\bfseries},
  failure/.style={circle, draw=none, fill=gray!15, minimum size=5mm},
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    surface/.style={rectangle, draw=none, fill=gray!10, rounded corners=4pt, minimum width=22mm, minimum height=10mm, align=center, font=\small},
    threat/.style={rectangle, draw=none, fill=gray!12, rounded corners=4pt, minimum width=22mm, minimum height=8mm, align=center, font=\small},
    control/.style={rectangle, draw=none, fill=gray!10, rounded corners=4pt, minimum width=22mm, minimum height=10mm, align=center, font=\small},
    crosscut/.style={rectangle, draw=none, fill=gray!8, rounded corners=4pt, minimum width=120mm, minimum height=7mm, align=center, font=\footnotesize},
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    constraint/.style={rectangle, draw=none, fill=red!10, rounded corners=4pt, minimum width=2.1cm, minimum height=0.85cm, align=center, font=\footnotesize\bfseries},
    slo/.style={rectangle, draw=none, fill=blue!10, rounded corners=4pt, minimum width=1.9cm, minimum height=0.75cm, align=center, font=\footnotesize\bfseries},
    lever/.style={rectangle, draw=none, fill=green!10, rounded corners=4pt, minimum width=1.9cm, minimum height=0.7cm, align=center, font=\footnotesize\bfseries},
...
\begin{tikzpicture}[
  ...
  phase/.style={
    ...
    draw=none, fill=gray!10,
    text width=26mm, % narrower to avoid extreme scaling
...
\node[phase, below=10mm of perf] (rag) {RAG\\(Ch.~\ref{ch:rag})};
\node[phase, right=4mm of rag] (orch) {Multi‑Agent\\(Ch.~\ref{ch:multiagent})};

% ---- Bottom row placed relative to second row ----
\node[phase, below=10mm of rag]   (test)   {Testing \& Robustness\\(Ch.~\ref{ch:testing})};
\node[phase, right=4mm of test]   (ethics) {Ethics \& Governance\\(Ch.~\ref{ch:ethics})};
\node[phase, right=4mm of ethics] (case)   {Case Study\\(Ch.~\ref{ch:case-study})};
...
\begin{tikzpicture}[
  ...
  source/.style={ellipse, fill=blue!20, draw=none, 
                 minimum width=17mm, minimum height=8mm, align=center, inner sep=2pt},
  ingest/.style={rectangle, fill=cyan!20, draw=none, rounded corners=4pt,
                 minimum width=19mm, minimum height=9mm, align=center, inner sep=2pt},
  vector/.style={cylinder, fill=teal!20, draw=none,
                 shape aspect=0.3, minimum width=19mm, minimum height=13mm, align=center, inner sep=2pt},
  rag/.style={rectangle, fill=purple!20, draw=none, rounded corners=4pt,
              minimum width=22mm, minimum height=11mm, align=center, inner sep=2pt},
  agent/.style={rectangle, fill=green!20, draw=none, rounded corners=4pt,
                minimum width=17mm, minimum height=8mm, align=center, inner sep=2pt},
  orchestrator/.style={rectangle, fill=orange!20, draw=none, rounded corners=4pt,
                       minimum width=24mm, minimum height=10mm, align=center, inner sep=2pt, font=\small\bfseries},
  gpu/.style={rectangle, fill=red!20, draw=none, rounded corners=4pt,
              minimum width=20mm, minimum height=11mm, align=center, inner sep=2pt},
  response/.style={ellipse, fill=gray!20, draw=none,
                  minimum width=19mm, minimum height=8mm, align=center, inner sep=2pt},
  obs/.style={rectangle, fill=yellow!8, draw=none, rounded corners=3pt, dashed,
