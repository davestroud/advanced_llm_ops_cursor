...
\begin{tikzpicture}[
  ...
  user/.style={ellipse, draw=black!70, fill=gray!10, line width=1pt, minimum width=22mm, minimum height=11mm, align=center, font=\small\bfseries},
  orchestrator/.style={rectangle, draw=black!70, fill=gray!20, line width=1pt, rounded corners=4pt, minimum width=38mm, minimum height=13mm, align=center, font=\small\bfseries},
  retriever/.style={rectangle, draw=black!60, fill=gray!10, line width=1pt, rounded corners=4pt, minimum width=30mm, minimum height=11mm, align=center, font=\small},
  knowledge/.style={rectangle, draw=black!60, fill=gray!10, line width=1pt, rounded corners=4pt, minimum width=28mm, minimum height=12mm, align=center, font=\small},
  llm/.style={rectangle, draw=black!70, fill=gray!15, line width=1pt, rounded corners=4pt, minimum width=28mm, minimum height=13mm, align=center, font=\small\bfseries},
  tool/.style={rectangle, draw=black!60, fill=gray!10, line width=1pt, rounded corners=4pt, minimum width=26mm, minimum height=11mm, align=center, font=\small},
  response/.style={ellipse, draw=black!70, fill=gray!10, line width=1pt, minimum width=22mm, minimum height=11mm, align=center, font=\small\bfseries},
  failure/.style={circle, draw=black!70, fill=gray!15, line width=1pt, minimum size=6mm},
  % Arrow styles (grayscale-safe with line styles)
  mainflow/.style={-{Latex}, line width=1pt, color=black!70},
  fallback/.style={-{Latex}, dashed, line width=1pt, color=black!50},
  toolflow/.style={-{Latex}, line width=1pt, color=black!60},
  retrieval/.style={-{Latex}, line width=1pt, color=black!60},
  queryflow/.style={-{Latex}, line width=1pt, color=black!70},
  label/.style={font=\small, color=black!60}
]
...
% Orchestrator (center)
\node[orchestrator, below=18mm of user] (orchestrator) {\begin{tabular}{c}Orchestrator\\\small LLM Application\end{tabular}};

% Retriever and Knowledge Base (left side)
\node[retriever, below left=16mm and 20mm of orchestrator] (retriever) {\begin{tabular}{c}Retriever\\\small (Vector DB)\end{tabular}};
\node[knowledge, below=14mm of retriever] (knowledge) {\begin{tabular}{c}Knowledge Base\\\small (Documents)\end{tabular}};

% LLM Model (right side)
\node[llm, below right=16mm and 20mm of orchestrator] (llm) {LLM Model};

% External Tool (below LLM)
\node[tool, below=14mm of llm] (tool) {\begin{tabular}{c}External Tool\\\small / API\end{tabular}};

% Failure indicator
\node[failure, left=8mm of retriever] (failure) {\textbf{×}};
...
\draw[-{Latex}, dashed, line width=1pt, color=black!50] (retriever) -- (failure);
\node[font=\small, color=black!60, left=3mm of failure] {Failure};
