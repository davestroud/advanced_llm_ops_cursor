...
% Start with first bubble, then position others relative to it
\node[bubble,cNews] (news) {News wires\\\& reports};
\node[bubble,cNGO, right=of news] (ngo) {NGO bulletins};
\node[bubble,cSocial, below=of news] (social) {Social media\\(vetted)};
\node[bubble,cHealth, below=of ngo] (health) {Public health\\\& infrastructure};

% Hub container fitted around the four bubbles
\node[hub, fit=(news) (ngo) (social) (health), 
      minimum width=90mm, minimum height=60mm, inner sep=8mm] (group) {};
