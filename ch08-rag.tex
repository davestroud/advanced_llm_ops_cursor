...
\begin{tabularx}{0.95\linewidth}{%
  >{\raggedright\arraybackslash}p{2.2cm}  % Index Type
  >{\raggedright\arraybackslash}p{2.0cm}  % Recall
  >{\raggedright\arraybackslash}p{2.3cm}  % Latency
  >{\raggedright\arraybackslash}p{2.3cm}  % Memory
  >{\raggedright\arraybackslash}p{2.3cm}  % Scale
  X                                        % Notes (flex)
}
\toprule
