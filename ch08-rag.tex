...
\begin{tabularx}{0.95\linewidth}{%
  >{\raggedright\arraybackslash}p{1.8cm}  % Index Type
  >{\raggedright\arraybackslash}p{1.6cm}  % Recall
  >{\raggedright\arraybackslash}p{2.0cm}  % Latency
  >{\raggedright\arraybackslash}p{2.0cm}  % Memory
  >{\raggedright\arraybackslash}p{2.0cm}  % Scale
  X                                        % Notes (flex)
}
\toprule
