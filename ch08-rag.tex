...
\begin{tikzpicture}[
    node distance=14mm,
    auto,
    block/.style={rectangle, draw=none, fill=gray!10, rounded corners, minimum height=8mm, minimum width=24mm, align=center, inner sep=3pt, font=\small},
...
\begin{tikzpicture}[
    node distance=14mm,
    auto,
    block/.style={rectangle, draw=none, fill=gray!10, rounded corners, minimum height=8mm, minimum width=26mm, align=center, inner sep=3pt, font=\small},
    arrow/.style={-{Latex}, line width=0.8pt}
]
