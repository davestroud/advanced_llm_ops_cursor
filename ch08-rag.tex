...
\begin{tikzpicture}[
    node distance=18mm,
    auto,
    block/.style={rectangle, draw=black!70, fill=gray!10, rounded corners, minimum height=10mm, minimum width=28mm, align=center, inner sep=4pt, font=\small},
...
\node[block, below of=gen, node distance=16mm] (ans) {Answer + citations};
...
\begin{tikzpicture}[
    node distance=18mm,
    auto,
    block/.style={rectangle, draw=black!70, fill=gray!10, rounded corners, minimum height=10mm, minimum width=30mm, align=center, inner sep=4pt, font=\small},
    arrow/.style={-{Latex}, line width=0.8pt}
]
...
\begin{tikzpicture}[
    node distance=17mm,
    auto,
    block/.style={rectangle, draw=black!70, fill=gray!6, rounded corners, minimum height=10mm, minimum width=31mm, align=center, inner sep=4pt, font=\small},
    arrow/.style={-{Latex}, line width=0.8pt}
]
