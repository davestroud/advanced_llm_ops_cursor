...
A production RAG system consists of \emph{offline} components (ingestion, cleaning, chunking, embedding, indexing) and \emph{online} components (query processing, retrieval, reranking, context construction, and generation). Fig.~\ref{fig:rag-querytime} summarizes the online query-time loop.
