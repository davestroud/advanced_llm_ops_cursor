...
\begin{table}[t]
\centering
\caption{Example observability stack (\ishtar) for LLM applications. OpenTelemetry provides shared context (trace IDs, resource attributes), while specialized tools deliver operator- and developer-facing views.}
\label{tab:ishtar_obs_stack}
