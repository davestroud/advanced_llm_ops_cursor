...
\begin{tikzpicture}[
  ...
  header/.style={font=\bfseries\ttfamily\footnotesize},
  attr/.style={font=\footnotesize},
  box/.style={rectangle, rounded corners=4pt, very thick, inner sep=6mm, text width=50mm},
  boxwide/.style={rectangle, rounded corners=4pt, very thick, inner sep=6mm, text width=0.35\linewidth},
...
\node[box, fill=llmblue!10, draw=llmblue, right=22mm of trace.north east, anchor=north west] (llm) {%
...
\draw[arrow] (trace.east) -- ++(10mm,0) |- (llm.west);
\draw[arrow] (trace.east) -- ++(10mm,0) |- (retr.west);
\draw[arrow] (trace.east) -- ++(10mm,0) |- (tool.west);
\draw[arrow] (trace.east) -- ++(10mm,0) |- (parser.west);
\draw[arrow] (trace.east) -- ++(10mm,0) |- (guard.west);

% --- Legend / Notes panel ---
\node[rectangle, rounded corners=4pt, draw=panelgray, fill=panelgray!5,
      below=18mm of tool, text width=0.95\linewidth, inner sep=6mm] (legend) {%
...
\node[rectangle, rounded corners=3pt, draw=panelgray, fill=panelgray!8,
  ...
  \bfseries\footnotesize Span Taxonomy \& Naming
};
