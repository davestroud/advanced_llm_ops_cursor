...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners=4pt, very thick, inner sep=7mm, text width=52mm},
  boxwide/.style={rectangle, rounded corners=4pt, very thick, inner sep=7mm, text width=0.32\linewidth},
...
\node[box, fill=llmblue!10, draw=llmblue, right=24mm of trace.north east, anchor=north west] (llm) {%
...
% --- Arrows from TRACE to spans (routed outside boxes) ---
\draw[arrow] (trace.east) -- ++(12mm,0) coordinate (mid1) -- (mid1 |- llm.west) -- (llm.west);
\draw[arrow] (trace.east) -- ++(12mm,0) coordinate (mid2) -- (mid2 |- retr.west) -- (retr.west);
\draw[arrow] (trace.east) -- ++(12mm,0) coordinate (mid3) -- (mid3 |- tool.west) -- (tool.west);
\draw[arrow] (trace.east) -- ++(12mm,0) coordinate (mid4) -- (mid4 |- parser.west) -- (parser.west);
\draw[arrow] (trace.east) -- ++(12mm,0) coordinate (mid5) -- (mid5 |- guard.west) -- (guard.west);

% --- Legend / Notes panel ---
\node[rectangle, rounded corners=4pt, draw=panelgray, fill=panelgray!5,
      below=20mm of tool, text width=0.95\linewidth, inner sep=7mm] (legend) {%
