...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners=3pt, very thick, inner sep=5mm, minimum width=65mm},
  boxwide/.style={rectangle, rounded corners=3pt, very thick, inner sep=5mm, minimum width=70mm},
  arrow/.style={->, very thick},
  dot/.style={circle, inner sep=1.2pt, fill=black}
]
...
\node[box, fill=parserviolet!10, draw=parserviolet, right=22mm of llm] (parser) {%
...
\node[rectangle, rounded corners=3pt, draw=panelgray, fill=panelgray!5,
      below=18mm of tool, minimum width=0.95\linewidth, inner sep=4mm] (legend) {%
...
\node[rectangle, rounded corners=2pt, draw=panelgray, fill=panelgray!8,
      above left=3mm and -3mm of trace.north east, anchor=south east, inner sep=3mm] (title) {%
