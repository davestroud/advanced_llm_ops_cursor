...
\begin{tikzpicture}[
  ...
  box/.style={rectangle, rounded corners=4pt, very thick, inner sep=5mm, text width=45mm},
  boxwide/.style={rectangle, rounded corners=4pt, very thick, inner sep=5mm, text width=0.4\linewidth},
  arrow/.style={->, very thick, line width=1pt},
...
\draw[arrow] (trace.east) -- ++(8mm,0) |- (llm.west);
\draw[arrow] (trace.east) -- ++(8mm,0) |- (retr.west);
\draw[arrow] (trace.east) -- ++(8mm,0) |- (tool.west);
\draw[arrow] (trace.east) -- ++(8mm,0) |- (parser.west);
\draw[arrow] (trace.east) -- ++(8mm,0) |- (guard.west);

% --- Legend / Notes panel ---
\node[rectangle, rounded corners=4pt, draw=panelgray, fill=panelgray!5,
      below=16mm of tool, text width=0.95\linewidth, inner sep=5mm] (legend) {%
