...
\begin{tikzpicture}[
  ...
  attr/.style={font=\normalsize},
  box/.style={rectangle, rounded corners=3pt, very thick, inner sep=7mm, minimum width=80mm, minimum height=20mm},
  boxwide/.style={rectangle, rounded corners=3pt, very thick, inner sep=7mm, minimum width=85mm, minimum height=22mm},
  arrow/.style={->, very thick, line width=1.5pt},
...
\node[box, fill=parserviolet!10, draw=parserviolet, right=24mm of llm] (parser) {%
...
\node[rectangle, rounded corners=3pt, draw=panelgray, fill=panelgray!5,
      below=20mm of tool, minimum width=0.95\linewidth, inner sep=5mm, minimum height=16mm] (legend) {%
