...
\begin{tikzpicture}[
  ...
  box/.style={draw=none, rounded corners=5pt, align=center, inner sep=5pt, font=\small\bfseries},
  arrow/.style={-{Latex}, line width=1.2pt, color=black!70},
  arrowDashed/.style={-{Latex}, dashed, dash pattern=on 3pt off 2pt, line width=1pt, color=black!60}
]
% Top row
\node[box, fill=ingestblue!15, minimum width=26mm, minimum height=10mm] (ingest) {Ingestion};
\node[box, fill=retrorange!15, minimum width=26mm, minimum height=10mm, right=of ingest] (retr) {Retrieval};
\node[box, fill=synthpurple!15, minimum width=26mm, minimum height=10mm, right=of retr] (synth) {Synthesis};

% Bottom row
\node[box, fill=verviolet!15, minimum width=26mm, minimum height=10mm, below=of synth] (verify) {Verification};
\node[box, fill=safered!15, minimum width=26mm, minimum height=10mm, left=of verify] (safety) {Safety};
\node[box, fill=delivergreen!15, minimum width=26mm, minimum height=10mm, left=of safety] (deliver) {Delivery};

% Orchestrator
\node[box, fill=orchteal!15, minimum width=30mm, minimum height=11mm, below=of retr, xshift=-34mm] (orch) {Orchestrator\\(router + budgets)};
