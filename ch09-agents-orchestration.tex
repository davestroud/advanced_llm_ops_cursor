...
\draw[arrow] (ingest) -- node[above, font=\small]{chunks + metadata} (retr);
\draw[arrow] (retr) -- node[above, font=\small]{context pack} (synth);
\draw[arrow] (synth) -- node[right, font=\small]{draft + citations} (verify);
\draw[arrow] (verify) -- node[below, font=\small]{verified answer} (safety);
\draw[arrow] (safety) -- node[below, font=\small]{user response} (deliver);
